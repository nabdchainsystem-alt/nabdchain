...
import { MagnifyingGlass, X, ArrowRight, Command, House, Tray, Folders, Gear, Users, ChartLine, Package, Clock, Lightning } from 'phosphor-react';
                    ...
                    <input
                        ...
                        aria-activedescendant={
                            flatList[selectedIndex]
                                ? `command-${flatList[selectedIndex].id}`
                                : undefined
                        }
                    />
                    <button
