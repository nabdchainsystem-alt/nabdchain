            ...
            <div className="flex border-b border-gray-100 dark:border-monday-dark-border">
                ...
                >
                    ...
                    {unreadAssignments.length > 0 && (
                        <span className={`px-1.5 py-0.5 text-xs rounded-full ${
                            activeTab === 'unread' ? 'bg-monday-blue text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300'
                        }`}>
                            {unreadAssignments.length}
                        </span>
                    )}
                ...
                >
                    ...
                    {readAssignments.length > 0 && (
                        <span className={`px-1.5 py-0.5 text-xs rounded-full ${
                            activeTab === 'read' ? 'bg-monday-blue text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300'
                        }`}>
            ...
            <div className="overflow-y-auto max-h-[380px]">
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-gray-500 dark:text-monday-dark-text-secondary">
                        ...
                        <p className="text-sm">
                            {activeTab === 'unread' ? 'No unread assignments' : 'No read assignments'}
                        </p>
                        <p className="text-xs mt-1 opacity-70">
                            {activeTab === 'unread' ? "You're all caught up!" : 'Read assignments will appear here'}
                        </p>
                    </div>
                ) : (
