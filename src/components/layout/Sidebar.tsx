...
const ACTIVE_SUB_NAV_STYLE =
  'font-outfit bg-gradient-to-br from-[#e9ecef] to-[#dee2e6] text-[#212529] shadow-sm border border-white/60 dark:from-[#495057] dark:to-[#343a40] dark:text-[#f8f9fa] dark:border-white/10';

const DEFAULT_QUICK_NAV = ['dashboard', 'my_work', 'inbox', 'vault'];

const SidebarTooltip: React.FC<{ content: string; children: React.ReactNode; enabled?: boolean }> = ({
  content,
  children,
  enabled = true,
}) => {
    ...
    <div className="flex flex-col items-center gap-3 relative w-full">
      ...
      {showSettings &&
        createPortal(
          ...
          >
            {/* Pages Section */}
            <p className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 mb-2 uppercase tracking-wider px-1">
              {t('pages')}
            </p>
              ...
              {ALL_QUICK_NAV_ITEMS.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isEnabled && (
                      <CheckSquare size={12} weight="fill" className="text-gray-900 dark:text-white shrink-0" />
                    )}
                  </button>
                );
              })}
            ...
            {boards.length > 0 && (
              <>
                <p className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 mb-2 uppercase tracking-wider px-1 border-t border-gray-100 dark:border-gray-700 pt-2">
                  {t('boards')}
                </p>
...
export const Sidebar: React.FC<SidebarProps> = React.memo(
  ({
    ...
    const [_isBoardHovered, _setIsBoardHovered] = useState(false);
    const [_isDashboardHovered, _setIsDashboardHovered] = useState(false);
    ...
    const [selectedLayout, setSelectedLayout] = useState<'table' | 'data_table' | 'datatable' | 'kanban' | 'list'>(
      'table',
    );
    ...
    useEffect(() => {
      ...
      const handleMouseMove = (e: MouseEvent) => {
        ...
        const delta = dir === 'rtl' ? initialMouseX - e.clientX : e.clientX - initialMouseX;
    ...
    const handleCreateBoard = (e: React.FormEvent) => {
      ...
      if (newBoardName.trim()) {
        onAddBoard(
          ...
          selectedTemplate,
          selectedLayout,
          parentBoardIdForCreation,
          newBoardNameDirection,
        );
    ...
    return (
      <>
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              transform: isCollapsed
                ? `translateX(${dir === 'rtl' ? expandedWidth - collapsedWidth : -(expandedWidth - collapsedWidth)}px)`
                : 'translateX(0)',
              ...
              <div className={`pt-3 pb-3 space-y-0.5 ltr:pl-5 ltr:pr-3 rtl:pr-5 rtl:pl-3 transition-none`}>
                <SidebarTooltip content={t('home')} enabled={isCollapsed}>
                  ...
                  >
                    ...
                    <span
                      key={dir}
                      className={`font-normal text-[14px] truncate min-w-0 flex-1 text-start leading-5 ${textBase} ${textVisibility}`}
                    >
                      {t('home')}
                    </span>
                  </button>
              ...
              <div className={`flex-1 min-h-0 overflow-y-auto py-2 no-scrollbar pl-5 pr-3 transition-none`}>
                  ...
                  <div className="mb-3">
                    {!isCollapsed && (
                      <div className="flex items-center justify-between mb-2 px-3">
                        <span className="text-xs font-semibold text-gray-500 dark:text-monday-dark-text-secondary truncate">
                          {t('departments')}
                        </span>
                      </div>
                    )}
                        ...
                        <SidebarTooltip content={t('overview')} enabled={isCollapsed}>
                          ...
                          >
                            ...
                            <CaretDown
                              size={13}
                              weight="light"
                              className={`text-gray-500 transition-colors duration-100 flex-shrink-0 ${expandedDepartments.has('mini_overview') ? 'rotate-180' : ''} ${isCollapsed ? 'max-w-0 opacity-0' : 'max-w-[20px] opacity-100'}`}
                            />
                          </div>
                        </SidebarTooltip>
                        {expandedDepartments.has('mini_overview') && !isCollapsed && (
                          <div className="ms-2 ps-3 border-s border-slate-300 dark:border-slate-600 mt-1 space-y-0.5">
                            <button
                              ...
                              onMouseEnter={() => preloadRoute('dashboards')}
                              className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-slate-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'dashboards' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                            >
                            ...
                            <button
                              ...
                              className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-slate-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'reports' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                            >
                        ...
                        <SidebarTooltip content={t('operations')} enabled={isCollapsed}>
                          ...
                          >
                            ...
                            <CaretDown
                              size={13}
                              weight="light"
                              className={`text-gray-500 transition-colors duration-100 flex-shrink-0 ${expandedDepartments.has('mini_operations') ? 'rotate-180' : ''} ${isCollapsed ? 'max-w-0 opacity-0' : 'max-w-[20px] opacity-100'}`}
                            />
                          </div>
                        </SidebarTooltip>
                          ...
                          <div className="ms-2 ps-3 border-s border-gray-300 dark:border-gray-600 mt-1 space-y-0.5">
                            {pageVisibility['sales'] !== false && (
                              <button
                                ...
                                onMouseEnter={() => preloadRoute('sales')}
                                className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'sales' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                              >
                            ...
                            {pageVisibility['purchases'] !== false && (
                              <button
                                ...
                                onMouseEnter={() => preloadRoute('purchases')}
                                className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'purchases' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                              >
                            ...
                            {pageVisibility['inventory'] !== false && (
                              <button
                                ...
                                className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'inventory' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                              >
                        ...
                        <SidebarTooltip content={t('finance')} enabled={isCollapsed}>
                          ...
                          >
                            ...
                            <CaretDown
                              size={13}
                              weight="light"
                              className={`text-gray-500 transition-colors duration-100 flex-shrink-0 ${expandedDepartments.has('mini_finance') ? 'rotate-180' : ''} ${isCollapsed ? 'max-w-0 opacity-0' : 'max-w-[20px] opacity-100'}`}
                            />
                          </div>
                        </SidebarTooltip>
                          ...
                          <div className="ms-2 ps-3 border-s border-zinc-300 dark:border-zinc-600 mt-1 space-y-0.5">
                            {pageVisibility['expenses'] !== false && (
                              <button
                                ...
                                onMouseEnter={() => preloadRoute('expenses')}
                                className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-zinc-500 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'expenses' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                              >
                        ...
                        <SidebarTooltip content={t('people')} enabled={isCollapsed}>
                          ...
                          >
                            ...
                            <CaretDown
                              size={13}
                              weight="light"
                              className={`text-gray-500 transition-colors duration-100 flex-shrink-0 ${expandedDepartments.has('mini_people') ? 'rotate-180' : ''} ${isCollapsed ? 'max-w-0 opacity-0' : 'max-w-[20px] opacity-100'}`}
                            />
                          </div>
                        </SidebarTooltip>
                          ...
                          <div className="ms-2 ps-3 border-s border-neutral-300 dark:border-neutral-600 mt-1 space-y-0.5">
                            {pageVisibility['customers'] !== false && (
                              <button
                                ...
                                onMouseEnter={() => preloadRoute('customers')}
                                className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-neutral-500 dark:text-neutral-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'customers' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                              >
                            ...
                            {pageVisibility['suppliers'] !== false && (
                              <button
                                ...
                                onMouseEnter={() => preloadRoute('suppliers')}
                                className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-neutral-500 dark:text-neutral-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'suppliers' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                              >
                          ...
                          <SidebarTooltip content={t('supply_chain')} enabled={isCollapsed}>
                            ...
                            >
                              ...
                              <CaretDown
                                size={13}
                                weight="light"
                                className={`text-gray-500 transition-colors duration-100 flex-shrink-0 ${expandedDepartments.has('supply_chain') ? 'rotate-180' : ''} ${isCollapsed ? 'max-w-0 opacity-0' : 'max-w-[20px] opacity-100'}`}
                              />
                            </div>
                          </SidebarTooltip>
                            ...
                            <div className="ms-2 ps-3 border-s border-stone-300 dark:border-stone-600 mt-1 space-y-0.5">
                              {pageVisibility['procurement'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('procurement')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-stone-500 dark:text-stone-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'procurement' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['warehouse'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('warehouse')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-stone-500 dark:text-stone-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'warehouse' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['fleet'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('fleet')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-stone-500 dark:text-stone-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'fleet' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['vendors'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('vendors')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-stone-500 dark:text-stone-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'vendors' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['planning'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('planning')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-stone-500 dark:text-stone-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'planning' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                          ...
                          <SidebarTooltip content={t('manufacturing')} enabled={isCollapsed}>
                            ...
                            >
                              ...
                              <CaretDown
                                size={13}
                                weight="light"
                                className={`text-gray-500 transition-colors duration-100 flex-shrink-0 ${expandedDepartments.has('operations') ? 'rotate-180' : ''} ${isCollapsed ? 'max-w-0 opacity-0' : 'max-w-[20px] opacity-100'}`}
                              />
                            </div>
                          </SidebarTooltip>
                            ...
                            <div className="ms-2 ps-3 border-s border-slate-300 dark:border-slate-600 mt-1 space-y-0.5">
                              {pageVisibility['maintenance'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('maintenance')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-slate-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'maintenance' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['production'] !== false && (
                                <button
                                  ...
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-slate-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'production' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['quality'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('quality')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-slate-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'quality' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                          ...
                          <SidebarTooltip content={t('business')} enabled={isCollapsed}>
                            ...
                            >
                              ...
                              <CaretDown
                                size={13}
                                weight="light"
                                className={`text-gray-500 transition-colors duration-100 flex-shrink-0 ${expandedDepartments.has('business') ? 'rotate-180' : ''} ${isCollapsed ? 'max-w-0 opacity-0' : 'max-w-[20px] opacity-100'}`}
                              />
                            </div>
                          </SidebarTooltip>
                          {expandedDepartments.has('business') && !isCollapsed && (
                            <div className="ms-2 ps-3 border-s border-zinc-300 dark:border-zinc-600 mt-1 space-y-0.5">
                              {pageVisibility['sales_listing'] !== false && (
                                <button
                                  onClick={() => onNavigate('sales_listing')}
                                  onMouseEnter={() => preloadRoute('sales_listing')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-zinc-500 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'sales_listing' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['sales_factory'] !== false && (
                                <button
                                  onClick={() => onNavigate('sales_factory')}
                                  onMouseEnter={() => preloadRoute('sales_factory')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-zinc-500 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'sales_factory' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                          ...
                          <SidebarTooltip content={t('business_support')} enabled={isCollapsed}>
                            ...
                            >
                              ...
                              <CaretDown
                                size={13}
                                weight="light"
                                className={`text-gray-500 transition-colors duration-100 flex-shrink-0 ${expandedDepartments.has('business_support') ? 'rotate-180' : ''} ${isCollapsed ? 'max-w-0 opacity-0' : 'max-w-[20px] opacity-100'}`}
                              />
                            </div>
                          </SidebarTooltip>
                            ...
                            <div className="ms-2 ps-3 border-s border-neutral-300 dark:border-neutral-600 mt-1 space-y-0.5">
                              {pageVisibility['it_support'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('it_support')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-neutral-500 dark:text-neutral-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'it_support' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['hr'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('hr')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-neutral-500 dark:text-neutral-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'hr' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                              ...
                              {pageVisibility['marketing'] !== false && (
                                <button
                                  ...
                                  onMouseEnter={() => preloadRoute('marketing')}
                                  className={`flex items-center gap-2 w-full px-2 py-1.5 rounded-sm text-[11.3px] text-neutral-500 dark:text-neutral-400 hover:bg-gray-100 dark:hover:bg-monday-dark-hover ${activeView === 'marketing' ? ACTIVE_SUB_NAV_STYLE : ''}`}
                                >
                ...
                <div className="mt-0 relative">
                  ...
                  <div className="relative group/workspace-card">
                    ...
                    >
                      <div
                        className={`w-6 h-6 rounded-md bg-gradient-to-tr ${activeWorkspace.color} text-white flex items-center justify-center text-xs font-bold flex-shrink-0`}
                      >
                        {(() => {
                          const WorkspaceIcon = ICON_MAP[activeWorkspace.icon];
                          return WorkspaceIcon ? (
                            <WorkspaceIcon size={13} weight="bold" />
                          ) : (
                      ...
                      <span
                        className={`font-medium text-[14px] text-[#323338] dark:text-[#dcdde2] truncate min-w-0 flex-1 text-start leading-5 ${textBase} ${textVisibility}`}
                      >
                      ...
                      {!isCollapsed && (
                        <div className="flex items-center gap-1">
                          ...
                          >
                            {dir === 'rtl' ? (
                              <CaretLeft size={13} weight="light" className="transition-transform duration-200" />
                            ) : (
                              ...
                              <form
                                onSubmit={(e) => {
                                  ...
                                  if (newBoardName.trim()) {
                                    ...
                                    const finalIcon =
                                      newBoardIcon && newBoardIcon !== 'Table'
                                        ? newBoardIcon
                                ...
                                <div className="mb-3 relative">
                                  ...
                                  >
                                    <div className="flex items-center gap-2">
                                      {React.createElement(ICON_MAP[newBoardIcon] || Table, {
                                        size: 14,
                                ...
                                <div className="grid grid-cols-2 gap-1 mb-3">
                                  {[
                                    ...
                                    >
                                      <layout.icon
                                        size={17}
                                        weight={selectedLayout === layout.id ? 'fill' : 'regular'}
                                      />
                              ...
                              return filteredWorkspaces.map((ws) => (
                                ...
                                >
                                  <div className="flex items-center gap-2 truncate">
                                    <div
                                      className={`w-5 h-5 rounded-sm bg-gradient-to-tr ${ws.color} text-white flex items-center justify-center text-[10px]`}
                                    >
                                      {(() => {
                                        const WorkspaceIcon = ICON_MAP[ws.icon];
                                        return WorkspaceIcon ? (
                                          <WorkspaceIcon size={12} weight="bold" />
                                        ) : (
                                          ws.name.charAt(0)
                                        );
                                      })()}
                                    ...
                                    <span
                                      className={`text-[14px] truncate ${ws.id === activeWorkspaceId ? 'font-medium text-monday-blue' : 'text-gray-600 dark:text-monday-dark-text'}`}
                                    >
                                      {ws.name}
                                    </span>
                                  </div>
                ...
                <div className="mt-2 space-y-1">
                  {(() => {
                      ...
                      return (
                        <div key={board.id} className="relative">
                          ...
                          >
                            ...
                            <span
                              className={`font-normal text-[13px] truncate min-w-0 flex-1 text-start leading-5 ${textBase} ${textVisibility}`}
                            >
                              {board.name}
                            </span>
                          ...
                          {hasChildren && !isCollapsed && isExpanded && (
                            <div
                              className={`${dir === 'rtl' ? 'mr-4 pr-1 border-r' : 'ml-4 pl-1 border-l'} border-gray-200 dark:border-monday-dark-border mt-0.5 space-y-0.5`}
                            >
                    ...
                    const rootBoards = workspaceBoards.filter(
                      (b) => !b.parentId || !workspaceBoards.find((p) => p.id === b.parentId),
                    );
          ...
          {/* End of inner content with transform */}
          ...
          >
            {(isCollapsed && dir === 'ltr') || (!isCollapsed && dir === 'rtl') ? (
                  ...
                  <form
                    onSubmit={(e) => {
                      ...
                      if (newBoardName.trim()) {
                        ...
                        // Use selected icon or fallback to layout default
                        const finalIcon =
                          newBoardIcon && newBoardIcon !== 'Table' ? newBoardIcon : iconMap[selectedLayout] || 'Table';
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-gray-700 dark:text-gray-300">
                            {t(newBoardIcon.toLowerCase()) || newBoardIcon}
                          </span>
                        </div>
            ...
            <div className="fixed inset-0 flex items-center justify-center z-[70]">
              ...
              <div className="relative bg-white dark:bg-monday-dark-surface rounded-xl shadow-2xl w-[450px] border border-gray-100 dark:border-monday-dark-border">
                <div className="p-5 border-b border-gray-100 dark:border-monday-dark-border flex justify-between items-center bg-gray-50/50 dark:bg-monday-dark-bg/50 rounded-t-xl">
                  <h3 className="font-semibold text-lg text-gray-800 dark:text-monday-dark-text">
                    {editingWorkspaceId ? t('edit_workspace') : t('add_workspace')}
                  </h3>
                  <button
                    onClick={() => {
                      setIsAddWorkspaceModalOpen(false);
                ...
                <form onSubmit={handleCreateWorkspace} className="p-6 space-y-5">
                  <div>
                    <label className="block text-xs font-bold text-gray-500 dark:text-monday-dark-text-secondary uppercase tracking-wider mb-2">
                      {t('workspace_name')}
                    </label>
                    <input
                      type="text"
                    ...
                    <div className="relative">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-10 h-10 rounded-sm bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-300`}
                          >
                        ...
                        <CaretDown
                          size={13}
                          weight="light"
                          className={`text-gray-400 transition-transform duration-300 ${isWorkspaceIconPickerOpen ? 'rotate-180' : ''}`}
                        />
                      </button>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-500 dark:text-monday-dark-text-secondary uppercase tracking-wider mb-3">
                      {t('text_direction')}
                    </label>
          ...
          {isNewBoardModalOpen && (
            <div className="fixed inset-0 z-[70] flex items-center justify-center">
              ...
              <div
                className={`relative bg-white dark:bg-monday-dark-surface rounded-xl shadow-2xl transition-colors duration-100 flex flex-col ${creationStep === 'template' ? 'w-[90vw] max-w-5xl h-[80vh]' : 'w-96 max-h-[90vh]'}`}
              >
                {/* Header */}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {[
                            ...
                            >
                              ...
                              <h4
                                className={`font-bold text-xs ${selectedLayout === tool.id ? 'text-monday-blue' : 'text-gray-700 dark:text-gray-200'}`}
                              >
                                {tool.label}
                              </h4>
                              {selectedLayout === tool.id && (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              {(() => {
                                ...
                                return (
                                  <div
                                    className={`w-10 h-10 rounded-sm flex items-center justify-center text-white bg-gradient-to-br ${gradient} shadow-md`}
                                  >
                            ...
                            <CaretDown
                              size={13}
                              weight="light"
                              className={`text-gray-400 transition-transform duration-300 ${isIconPickerOpen ? 'rotate-180' : ''}`}
                            />
                          </button>
