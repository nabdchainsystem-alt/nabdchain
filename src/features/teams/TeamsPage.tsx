                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    ...
                                                    <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0 duration-200">
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-2 hover:bg-white dark:hover:bg-gray-700 text-gray-400 hover:text-monday-blue rounded-full shadow-sm border border-transparent hover:border-gray-100 transition-all tooltip" title="View Profile">
