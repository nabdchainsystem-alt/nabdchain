...
export const DeveloperLoginModal: React.FC<DeveloperLoginModalProps> = ({ isOpen, onClose }) => {
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        if (email === 'master@nabdchain.com' && password === '2450') {
            ...
            setError('Invalid credentials for Development Mode');
            setLoading(false);
        }
    };
                ...
                <>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="bg-white w-full max-w-[400px] rounded-xl shadow-[0_16px_32px_-8px_rgba(0,0,0,0.08),0_4px_8px_-4px_rgba(0,0,0,0.1)] overflow-hidden relative border border-zinc-200"
                        >
                            <button
                                onClick={onClose}
                                className="absolute top-4 right-4 p-1 text-zinc-400 hover:text-zinc-600 rounded-md transition-colors focus:outline-none"
                            >
                                <X size={20} />
                            </button>
                            ...
                            <div className="p-10 pb-8">
                                <div className="text-center mb-8">
                                    ...
                                    <h2 className="text-xl font-bold text-zinc-900 mb-2">Sign in to NabdChain</h2>
                                ...
                                <div className="space-y-3 mb-6">
                                    <button
                                        ...
                                        disabled={loading}
                                        className="w-full h-10 border border-zinc-200 rounded-md flex items-center justify-center gap-3 text-sm font-medium text-zinc-700 hover:bg-zinc-50 transition-colors focus:outline-none focus:ring-2 focus:ring-[#6C47FF]/20 focus:border-[#6C47FF]"
                                    >
                                ...
                                <form onSubmit={handleFormSubmit} className="space-y-4">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-9 rounded-md border border-zinc-200 px-3 text-sm text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#6C47FF]/20 focus:border-[#6C47FF] transition-all"
                                            placeholder=""
                                        />
                                    </div>
                                    ...
                                    >
                                        {loading ? <Spinner className="animate-spin" size={16} /> : 'Continue'}
                                    </button>
                                </form>
                            </div>
                            ...
                            <div className="bg-zinc-50 border-t border-zinc-100 p-4 text-center">
                                <p className="text-xs text-zinc-500">
                                    Don't have an account? <a href="#" className="text-[#6C47FF] hover:underline font-medium">Sign up</a>
                                </p>
                            </div>
