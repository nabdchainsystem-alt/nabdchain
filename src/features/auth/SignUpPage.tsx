            ...
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
              <motion.div variants={itemVariants}>
                ...
                <div className="relative group">
                  <Building
                    className="absolute start-3 top-3 text-gray-400 group-hover:text-black dark:group-hover:text-white transition-colors"
                    size={18}
                  />
                  <select
            ...
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <motion.div variants={itemVariants}>
                  ...
                  <div className="relative group">
                    <User
                      className="absolute start-3 top-3.5 text-gray-400 group-hover:text-black dark:group-hover:text-white transition-colors"
                      size={18}
                    />
                    <input
                      type="text"
            ...
            >
              ...
              <motion.div variants={itemVariants}>
                ...
                <p className="text-gray-500 text-sm">
                  ...
                  <span className="font-semibold text-gray-800 dark:text-gray-200">{formData.email}</span>
                </p>
              </motion.div>
        ...
        <div className="max-w-md mx-auto w-full flex-1 flex flex-col justify-center pt-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">
              {step === 'discovery'
                ? t('customize_workspace_industry')
                : step === 'personal'
                  ? t('enter_details_personalize')
                  : step === 'account'
        ...
        <div className="relative z-10 text-center px-12 w-full max-w-2xl h-full flex flex-col justify-center">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-gray-300/80 mb-12 text-lg leading-relaxed max-w-lg mx-auto">{currentSlide.desc}</p>
              ...
              <div className="flex flex-col gap-6 items-center">
                {currentSlide.features.map((item, i) => (
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-lg ${currentSlide.theme.iconBg} flex items-center justify-center shrink-0`}
                    >
