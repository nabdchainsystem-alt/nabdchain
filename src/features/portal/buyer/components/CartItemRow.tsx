...
export const CartItemRow = React.memo<CartItemRowProps>(
  ({
    ...
    const priceType: 'confirmed' | 'estimated' =
      isFixedPrice && allowDirectPurchase && isBuyNowEligible ? 'confirmed' : 'estimated';
        ...
        <div className={`flex-1 min-w-0 ${isRtl ? 'text-right' : ''}`}>
          ...
          <div className={`flex items-start justify-between gap-2 ${isRtl ? 'flex-row-reverse' : ''}`}>
            <div className="flex-1 min-w-0">
              ...
              <div
                className={`flex items-center gap-2 text-xs flex-wrap ${isRtl ? 'flex-row-reverse' : ''}`}
            ...
            <div className={`flex items-center gap-2 ${isRtl ? 'flex-row-reverse' : ''}`}>
              ...
              >
                ...
                <button
                  ...
                  className="p-1.5 transition-colors disabled:opacity-50"
                  style={{
                    color: maxOrderQty && localQuantity >= maxOrderQty ? styles.textMuted : styles.textPrimary,
                  }}
                >
          ...
          {showPurchaseMethod && (
            <div className={`flex items-center gap-2 mt-2 ${isRtl ? 'flex-row-reverse' : ''}`}>
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    selectedMethod === 'buy_now' && isBuyNowEligible ? `${styles.success}15` : styles.bgSecondary,
                  color:
              ...
              >
                ...
                <span>Buy Now</span>
                {selectedMethod === 'buy_now' && isBuyNowEligible && <Check size={12} weight="bold" />}
              </button>
              ...
              <button
                ...
                style={{
                  backgroundColor: selectedMethod === 'request_quote' ? `${styles.info}15` : styles.bgSecondary,
                  color: selectedMethod === 'request_quote' ? styles.info : styles.textSecondary,
                  border: selectedMethod === 'request_quote' ? `1px solid ${styles.info}40` : '1px solid transparent',
                }}
                title="Request negotiated pricing"
              >
                <ChatCircleText size={12} weight={selectedMethod === 'request_quote' ? 'fill' : 'regular'} />
                <span>Request Quote</span>
                {selectedMethod === 'request_quote' && <Check size={12} weight="bold" />}
              </button>
