...
export const ExportButton: React.FC<ExportButtonProps> = ({
  ...
  const getVariantClasses = () => {
    const base = 'inline-flex items-center justify-center gap-1.5 font-medium rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2';

    switch (variant) {
      case 'primary':
        return `${base} ${styles.colors.primary.replace('text-', 'bg-').replace('600', '600')} text-white hover:opacity-90 focus:ring-blue-500`;
      case 'secondary':
