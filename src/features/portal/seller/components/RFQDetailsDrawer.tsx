...
export const RFQDetailsDrawer: React.FC<RFQDetailsDrawerProps> = memo(
  ({ rfq, isOpen, onClose, onToggleSave, onSubmitQuote }) => {
    ...
    const _statusConfig = getMarketplaceStatusConfig(displayRfq.status);
    const buyerBadgeConfig = getBuyerBadgeConfig(displayRfq.buyer.badge);
    const _urgencyConfig = getUrgencyConfig(displayRfq.deadlineUrgency);
    ...
    return (
      <>
        ...
        <div className="fixed inset-0 z-40" style={{ top: '64px' }} onClick={handleOverlayClick} />
        ...
        <div
          ...
          style={{
            ...
            right: isRtl ? 'auto' : 0,
            left: isRtl ? 0 : 'auto',
            transform: isAnimating ? 'translateX(0)' : `translateX(${isRtl ? '-100%' : '100%'})`,
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
            ...
            <div className="flex items-center gap-4 text-sm">
              <div className="flex items-center gap-1.5 text-gray-600">
                ...
                <span
                  ...
                  style={{
                    backgroundColor:
                      competitionLevel === 'low' ? '#dcfce7' : competitionLevel === 'medium' ? '#fef3c7' : '#fee2e2',
                    color:
                      competitionLevel === 'low' ? '#166534' : competitionLevel === 'medium' ? '#92400e' : '#991b1b',
                  }}
                >
                  {competitionLevel}
                </span>
            ...
            {/* Request Details */}
            <section>
              <h3 className="text-xs font-medium uppercase tracking-wider text-gray-400 mb-3">Request Details</h3>
              <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                {displayRfq.description && (
                  <p className="text-sm text-gray-700 leading-relaxed">{displayRfq.description}</p>
                )}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {formatQuantity(displayRfq.quantity, displayRfq.unit)}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {displayRfq.deliveryCity || displayRfq.deliveryCountry}
                      </p>
                    </div>
                  </div>
            ...
            {/* Buyer Info */}
            <section>
              <h3 className="text-xs font-medium uppercase tracking-wider text-gray-400 mb-3">Buyer Information</h3>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  >
                    ...
                    {buyerBadgeConfig.icon === 'user' && <User size={20} style={{ color: buyerBadgeConfig.color }} />}
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>
                      {displayRfq.buyer.city}, {displayRfq.buyer.country}
                    </span>
                  </div>
            ...
            {displayRfq.attachments && displayRfq.attachments.length > 0 && (
              <section>
                <h3 className="text-xs font-medium uppercase tracking-wider text-gray-400 mb-3">Attachments</h3>
          ...
          <div className="flex-shrink-0 px-5 py-4 space-y-3 bg-white" style={{ borderTop: '1px solid #e5e7eb' }}>
            ...
            <div className="flex gap-2">
              ...
              <button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-medium bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors">
                <ChatCircle size={15} />
                Ask Question
              </button>
            </div>
