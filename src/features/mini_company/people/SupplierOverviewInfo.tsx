...
import { X, Info, CaretRight, CaretDown, Package, Truck, Wallet } from 'phosphor-react';
                ...
                <div className={`flex-1 overflow-y-auto p-6 space-y-8 text-gray-600 dark:text-gray-300 pb-24 ${isRTL ? 'text-right' : ''}`}>
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div>
                                <h4 className={`text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-3 ${isRTL ? 'text-right' : 'text-left'}`}>{t('key_performance_indicators')}</h4>
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div className="bg-gray-50 dark:bg-gray-800/30 rounded-lg border border-gray-100 dark:border-gray-700 p-3">
                                        <div className="font-bold text-xs text-gray-800 dark:text-gray-200 mb-1">{t('tier_definition')}</div>
