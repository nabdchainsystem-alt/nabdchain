...
export const PurchaseOverviewDashboard: React.FC = () => {
  ...
  const TOP_KPIS = useMemo<KPIData[]>(
    () => [
      {
        id: '1',
        label: t('total_purchase_spend'),
        subtitle: t('ytd_approved'),
        value: '0',
        rawValue: 1245000,
        isCurrency: true,
        change: '+8.5%',
        ...
        sparklineData: [90, 95, 100, 98, 105, 110, 120],
        color: 'blue',
      },
      {
        id: '2',
        ...
        sparklineData: [120, 125, 130, 128, 135, 140, 145],
        color: 'blue',
      },
      {
        id: '3',
        label: t('active_suppliers'),
        subtitle: t('engaged_this_month'),
        value: '24',
        change: '+2',
        trend: 'up',
        icon: <Users size={18} />,
        sparklineData: [20, 21, 21, 22, 22, 23, 24],
        color: 'blue',
      },
      {
        id: '4',
        label: t('avg_purchase_value'),
        ...
        trend: 'down',
        icon: <Hash size={18} />,
        sparklineData: [8.8, 8.7, 8.6, 8.9, 8.7, 8.6, 8.5],
        color: 'blue',
      },
    ],
    [t],
  ...
  const SIDE_KPIS = useMemo<KPIData[]>(
    () => [
      {
        id: '5',
        label: t('monthly_spend_change'),
        subtitle: t('mom_variance'),
        value: '+5.4%',
        change: '+1.1%',
        trend: 'up',
        icon: <TrendUp size={18} />,
        sparklineData: [3, 4, 3.5, 4.2, 4.8, 5.0, 5.4],
        color: 'blue',
      },
      {
        id: '6',
        label: t('top_supplier_spend'),
        subtitle: t('concentration_risk'),
        value: '18%',
        change: '-2%',
        trend: 'down',
        icon: <ChartPieSlice size={18} />,
        sparklineData: [22, 21, 20, 19.5, 19, 18.5, 18],
        color: 'blue',
      },
      {
        id: '7',
        label: t('purchase_frequency'),
        subtitle: t('days_between_orders'),
        value: '3.2d',
        change: '-0.5d',
        trend: 'up',
        icon: <Activity size={18} />,
        sparklineData: [4, 3.8, 3.6, 3.5, 3.4, 3.3, 3.2],
        color: 'blue',
      },
      {
        id: '8',
        label: t('unplanned_purchase_rate'),
        subtitle: t('outside_approved_plan'),
        value: '12%',
        change: '-3%',
        trend: 'up',
      ...
      series: [
        {
          ...
          data: SPEND_DISTRIBUTION.map((d, i) => ({
            ...d,
            itemStyle: { color: COLORS_SEQUENCE[i % COLORS_SEQUENCE.length] },
          })),
        },
      ],
    }),
      ...
      series: [
        {
          ...
          label: { show: false },
          emphasis: { label: { show: false } },
          data: SUPPLIER_SHARE.map((d, i) => ({
            ...d,
            itemStyle: { color: COLORS_SEQUENCE[(i + 2) % COLORS_SEQUENCE.length] },
          })),
        },
      ],
    }),
    ...
    return {
      tooltip: {
        ...
        formatter: (params: CallbackDataParams | CallbackDataParams[]) => {
          ...
          const cat = merimekkoData[arr[0].dataIndex];
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                  {RECENT_ORDERS.map((order) => (
                    <tr key={order.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                      ...
                      <td className="px-5 py-3 text-gray-500 dark:text-gray-400 text-xs text-start">
                        {order.category}
                      </td>
        ...
        {isLoading ? (
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2 bg-white dark:bg-monday-dark-elevated p-5 rounded-2xl border border-gray-100 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-shadow animate-fade-in-up">
            <div className="mb-4 text-start">
              <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200 uppercase tracking-wider">
                {t('spend_concentration_category')}
              </h3>
