            ...
            >
                <div className="flex-none flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-monday-dark-surface z-10 text-start">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{t('supplier_performance_subtitle')}</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 text-gray-600 dark:text-gray-300 pb-24 text-start">
                    <section>
                        ...
                        <p className="text-sm leading-relaxed p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-700">
                            {t('supplier_performance_overview')}
                        </p>
                    </section>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('total_suppliers')} desc={t('total_suppliers_desc')} />
                                    <DetailItem title={t('on_time_delivery_pct')} desc={t('on_time_delivery_desc')} />
                                    <DetailItem title={t('avg_lead_time')} desc={t('avg_lead_time_desc')} />
                                    <DetailItem title={t('cost_variance_pct')} desc={t('cost_variance_desc')} />
                                    <DetailItem title={t('supplier_dependency_index')} desc={t('supplier_dependency_desc')} />
                                    <DetailItem title={t('dispute_rate')} desc={t('dispute_rate_desc')} />
                                    <DetailItem title={t('preferred_suppliers_count')} desc={t('preferred_suppliers_desc')} />
                                    <DetailItem title={t('supplier_concentration_pct')} desc={t('supplier_concentration_desc')} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('spend_per_supplier')} desc={t('spend_per_supplier_desc')} />
                                    <DetailItem title={t('lead_time_per_supplier')} desc={t('lead_time_per_supplier_desc')} />
                                    <DetailItem title={t('supplier_risk_distribution')} desc={t('supplier_risk_distribution_desc')} />
                                    <DetailItem title={t('supplier_performance_table')} desc={t('supplier_performance_table_desc')} />
                                    <DetailItem title={t('risk_scatter_matrix')} desc={t('risk_scatter_matrix_desc')} />
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-4">
                                    <TableSchema
                                        name={`1. ${t('suppliers_table')}`}
                                        desc={t('suppliers_table_desc')}
                                        columns={[t('sp_col_id'), t('sp_col_name'), t('sp_col_risk_rating'), t('status')]}
                                    />
                                    <TableSchema
                                        name={`2. ${t('purchase_orders_table')}`}
                                        desc={t('purchase_orders_desc')}
                                        columns={[t('sp_col_po_date'), t('sp_col_delivery_date'), t('sp_col_promised_date'), t('sp_col_amount')]}
                                    />
                                    <TableSchema
                                        name={`3. ${t('disputes_table')}`}
                                        desc={t('disputes_table_desc')}
                                        columns={[t('sp_col_dispute_id'), t('sp_col_po_id'), t('sp_col_reason')]}
                                    />
                                </div>
                            </div>
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-xl border border-blue-100 dark:border-blue-800/30">
                                ...
                                <ul className="space-y-2.5 text-xs text-blue-900/80 dark:text-blue-200/80 ms-1">
                                    <li className="flex gap-2 text-start">
                                        ...
                                        <span><strong>{t('sp_calc_ontime')}</strong> {t('sp_calc_ontime_formula')}</span>
                                    </li>
                                    <li className="flex gap-2 text-start">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" />
                                        <span><strong>{t('sp_calc_leadtime')}</strong> {t('sp_calc_leadtime_formula')}</span>
                                    </li>
                                    <li className="flex gap-2 text-start">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" />
                                        <span><strong>{t('sp_calc_risk')}</strong> {t('sp_calc_risk_formula')}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
