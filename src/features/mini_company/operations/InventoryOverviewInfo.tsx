...
import { X, Info, CaretRight, CaretDown, Package, Table as TableIcon, Calculator } from 'phosphor-react';
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-emerald-50 dark:bg-emerald-900/10 p-4 rounded-xl border border-emerald-100 dark:border-emerald-800/30">
                                ...
                                <ul className="space-y-2.5 text-xs text-emerald-900/80 dark:text-emerald-200/80 ms-1">
                                    <li className="flex gap-2 text-start">
                                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
                                        <span><strong>{t('value')}:</strong> {t('io_calc_value')}</span>
                                    </li>
                                    <li className="flex gap-2 text-start">
                                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
                                        <span><strong>{t('in_stock_rate')}:</strong> {t('io_calc_in_stock_rate')}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
