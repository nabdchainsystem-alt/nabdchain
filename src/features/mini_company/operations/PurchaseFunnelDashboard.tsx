...
export const PurchaseFunnelDashboard: React.FC = () => {
  ...
  const TOP_KPIS = useMemo<KPIData[]>(
    () => [
      {
        id: '1',
        label: t('requests_submitted'),
        subtitle: t('total_intake'),
        value: '142',
        change: '+12',
        trend: 'up',
        icon: <Funnel size={18} />,
        sparklineData: [100, 110, 115, 120, 130, 135, 142],
      },
      {
        id: '2',
        ...
        sparklineData: [60, 65, 70, 75, 80, 85, 89],
      },
      {
        id: '3',
        label: t('avg_approval_time'),
        subtitle: t('end_to_end'),
        value: '42h',
        change: '-4h',
        trend: 'up',
        icon: <Timer size={18} />,
  ...
  const SIDE_KPIS = useMemo<KPIData[]>(
    () => [
      {
        id: '5',
        label: t('bottleneck_stage'),
        subtitle: t('highest_delay'),
        value: t('finance'),
        change: '',
        trend: 'neutral',
      ...
      {
        id: '6',
        label: t('delayed_requests'),
        subtitle: t('over_sla'),
        value: '14',
        change: '+3',
        trend: 'down',
        icon: <Timer size={18} />,
        sparklineData: [10, 11, 12, 11, 12, 13, 14],
      },
      {
        id: '7',
        ...
        sparklineData: [28, 27, 26, 26, 25, 25, 25],
      },
      {
        id: '8',
        label: t('sla_compliance'),
        subtitle: t('on_time_rate'),
        value: '86%',
        change: '+3%',
        trend: 'up',
        icon: <CheckCircle size={18} />,
        sparklineData: [80, 81, 82, 83, 84, 85, 86],
      },
    ],
    [t],
  );
