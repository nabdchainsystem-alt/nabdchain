...
export const SalesFunnelDashboard: React.FC<SalesFunnelDashboardProps> = ({ hideFullscreen = false }) => {
  ...
  const TOP_KPIS = useMemo(
    () => [
      {
        id: '1',
        label: t('leads_entered'),
        subtitle: t('new_potential_leads'),
        value: '1,248',
        change: '+12%',
        trend: 'up' as const,
        icon: <Users size={18} />,
        sparklineData: [980, 1020, 1080, 1120, 1180, 1220, 1248],
      },
      {
        id: '2',
        label: t('leads_contacted'),
        subtitle: t('first_outreach_made'),
        value: '984',
        change: '+8%',
        trend: 'up' as const,
        icon: <Notepad size={18} />,
        sparklineData: [820, 850, 880, 910, 940, 960, 984],
      },
      {
        id: '3',
        label: t('quotes_sent'),
        subtitle: t('price_proposals_delivered'),
        value: '642',
        change: '+15%',
        trend: 'up' as const,
        icon: <CurrencyDollar size={18} />,
        sparklineData: [480, 510, 540, 570, 600, 620, 642],
      },
      {
        id: '4',
        label: t('orders_placed'),
        subtitle: t('closed_won_deals'),
        value: '420',
        change: '+5%',
        trend: 'up' as const,
        icon: <ShoppingCart size={18} />,
        sparklineData: [360, 375, 385, 395, 405, 415, 420],
      },
    ],
    [t],
  );
    ...
    () => [
      {
        ...
        subtitle: t('leads_to_orders'),
        value: '33.6%',
        change: '+2.4%',
        trend: 'up' as const,
        icon: <Percent size={18} />,
        sparklineData: [28, 29.5, 30.5, 31.5, 32.2, 33, 33.6],
      },
      {
        id: '6',
        label: t('funnel_dropoff'),
        subtitle: t('avg_stage_leakage'),
        value: '18.5%',
        change: '-1.2%',
        trend: 'up' as const,
        icon: <TrendDown size={18} />,
        sparklineData: [22, 21, 20.5, 20, 19.5, 19, 18.5],
      },
      {
        id: '7',
        label: t('potential_revenue_lost'),
        subtitle: t('value_in_dropped_deals'),
        value: '0',
        rawValue: 184500,
        isCurrency: true,
        change: '+4%',
        ...
        sparklineData: [165, 170, 175, 178, 180, 182, 184.5],
      },
      {
        id: '8',
        label: t('avg_deal_size'),
        subtitle: t('won_deals_value'),
        value: '0',
        rawValue: 28500,
        isCurrency: true,
        change: '+6%',
        trend: 'up' as const,
        icon: <CurrencyDollar size={18} />,
        sparklineData: [24, 25, 26, 26.5, 27, 28, 28.5],
      },
    ],
    [t],
  );
                    ...
                    {paginatedData.map((row) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-5 text-end font-bold text-gray-900 dark:text-white">
                          {formatCurrency(row.value, currency.code, currency.symbol)}
                        </td>
