...
export const ReorderPlanningInfo: React.FC<ReorderPlanningInfoProps> = ({ isOpen, onClose }) => {
    ...
    const questions = [
        { q: 'What items need reordering now?', a: 'Check "Items Below Reorder Point". These SKUs have fallen below their safety threshold and need urgent action.' },
        { q: 'How many days of stock do we have?', a: '"Days of Stock Left" estimates how long current inventory will last based on average daily sales velocity.' },
        { q: 'What is the "Reorder Point"?', a: 'The inventory level that signals replenishment is needed. It accounts for lead time and safety stock.' },
        { q: 'Are we overstocked?', a: 'Yes, "Overstock Items" highlights SKUs where quantity exceeds maximum holding limits, tying up capital unnecessarily.' }
    ];
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 text-gray-600 dark:text-gray-300 pb-24">
                    <section>
                        ...
                        <p className="text-sm leading-relaxed p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-700">
                            This dashboard ensures stock levels are maintained efficiently by flagging items needing replenishment vs those that are overstacked.
                        </p>
                    </section>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title="Items Below Reorder" desc="SKUs where QoH &lt; Reorder Point." />
                                    <DetailItem title="Reorder Qty Needed" desc="Total units required to restore safety levels." />
                                    <DetailItem title="Avg Lead Time" desc="Typical days for supplier delivery." />
                                    <DetailItem title="Days of Stock Left" desc="Runway calculation based on sales velocity." />
                                    <DetailItem title="Emergency Reorders" desc="Orders placed with expedited shipping." />
                                    <DetailItem title="Overstock Items" desc="SKUs exceeding maximum capacity." />
                                    <DetailItem title="Planning Confidence" desc="Reliability of demand vs supply data." />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title="Reorder Qty by SKU" desc="Bar chart (Recharts) showing replenishment volume per item." />
                                    <DetailItem title="Stock Coverage" desc="Pie chart (ECharts) grouping items by days of supply." />
                                    <DetailItem title="Plan Sheet" desc="Table listing suggested order quantities." />
                                    <DetailItem title="Threshold Wave" desc="Visualizes urgency of items approaching zero." />
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    <TableSchema
                                        ...
                                        desc="Replenishment params."
                                        columns={['SKU', 'MinStock', 'MaxStock', 'ReorderPoint', 'SafetyStock']}
                                    />
                                </div>
                            </div>
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-xl border border-blue-100 dark:border-blue-800/30">
                                ...
                                <ul className="space-y-2.5 text-xs text-blue-900/80 dark:text-blue-200/80 ml-1">
                                    <li className="flex gap-2">
                                        ...
                                        <span><strong>ROP</strong> = (Daily Usage * Lead Time) + Safety Stock.</span>
                                    </li>
                                    <li className="flex gap-2">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" />
                                        <span><strong>Order Qty</strong> = Max Stock - Current Stock.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
