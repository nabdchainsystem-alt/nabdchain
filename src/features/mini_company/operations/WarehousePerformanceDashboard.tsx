...
export const WarehousePerformanceDashboard: React.FC = () => {
  ...
  const TOP_KPIS = useMemo(
    () => [
      ...
      {
        id: '2',
        label: t('total_utilization'),
        subtitle: t('capacity_used'),
        value: '78%',
        change: '+3%',
        trend: 'up' as const,
        icon: <Cube size={18} />,
        sparklineData: [70, 72, 75, 76, 77, 78],
        color: 'blue',
      },
      {
        id: '3',
        label: t('picking_time_avg'),
      ...
      {
        id: '4',
        label: t('fulfillment_speed'),
        subtitle: t('orders_per_hour'),
        value: '45',
        change: '+5',
        trend: 'up' as const,
  ...
  const SIDE_KPIS = useMemo(
    () => [
      {
        id: '5',
        label: t('storage_efficiency'),
        subtitle: t('cubic_usage'),
        value: '88%',
        change: '+2%',
        trend: 'up' as const,
        icon: <ChartBar size={18} />,
        sparklineData: [84, 85, 86, 87, 88, 88],
        color: 'blue',
      },
      {
        id: '6',
        label: t('error_rate'),
        subtitle: t('pick_pack'),
        value: '0.8%',
        change: '-0.1%',
        trend: 'up' as const,
        icon: <Warning size={18} />,
        sparklineData: [1.2, 1.1, 1.0, 0.9, 0.9, 0.8],
        color: 'blue',
      },
      {
        id: '7',
        label: t('capacity_alerts'),
        subtitle: t('near_full'),
        value: '1',
        change: '0',
        trend: 'down' as const,
        icon: <Warning size={18} />,
        sparklineData: [2, 2, 1, 1, 1, 1],
        color: 'blue',
      },
      {
        id: '8',
        label: t('on_time_ship'),
        subtitle: t('fulfillment_pct'),
        value: '96.5%',
        change: '+1.2%',
        trend: 'up' as const,
        icon: <CheckCircle size={18} />,
        sparklineData: [93, 94, 94.5, 95, 95.8, 96.5],
        color: 'blue',
      },
    ],
    [t],
  ...
  const warehousePerformanceOption = useMemo<EChartsOption>(
    () => ({
      ...
      legend: {
        ...
        itemWidth: 10,
        itemHeight: 10,
        data: [t('picking'), t('shipping'), t('storage')],
      },
