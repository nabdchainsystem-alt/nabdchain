...
export const ReorderPlanningDashboard: React.FC = () => {
  ...
  const TOP_KPIS = useMemo(
    () => [
      {
        id: '1',
        label: t('below_reorder_point'),
        subtitle: t('action_required'),
        value: '18',
        change: '+4',
        trend: 'down' as const,
      ...
      {
        id: '2',
        label: t('reorder_qty_needed'),
        subtitle: t('to_max_level'),
        value: '2,450',
        rawValue: 2450,
        isCurrency: false,
        change: '+12%',
        ...
        sparklineData: [2000, 2100, 2200, 2300, 2400, 2450],
        color: 'blue',
      },
      {
        id: '3',
        label: t('avg_lead_time'),
        subtitle: t('supplier_speed'),
        value: '12d',
        change: '+1d',
        trend: 'down' as const,
        icon: <Clock size={18} />,
      ...
      {
        id: '4',
        label: t('days_stock_left'),
        subtitle: t('runway'),
        value: '24d',
        change: '-2d',
        trend: 'down' as const,
        icon: <Package size={18} />,
        sparklineData: [28, 27, 26, 25, 25, 24],
        color: 'blue',
      },
    ],
    [t],
  ...
  const SIDE_KPIS = useMemo(
    () => [
      {
        id: '5',
        label: t('emergency_reorders'),
        subtitle: t('expedited'),
        value: '3',
        change: '-1',
        trend: 'up' as const,
        icon: <Lightning size={18} />,
        sparklineData: [5, 4, 4, 3, 3, 3],
        color: 'blue',
      },
      {
        id: '6',
        label: t('overstock_items'),
        subtitle: t('above_max_limit'),
        value: '45',
        change: '+5',
        trend: 'down' as const,
      ...
      {
        id: '7',
        label: t('planning_confidence'),
        subtitle: t('data_reliability'),
        value: '92%',
        change: '+1%',
        trend: 'up' as const,
        icon: <ShieldCheck size={18} />,
        sparklineData: [90, 91, 91, 91, 92, 92],
        color: 'blue',
      },
      {
        id: '8',
        label: t('stockout_risk'),
        subtitle: t('items_at_risk'),
        value: '8',
        change: '-2',
        trend: 'up' as const,
        icon: <Warning size={18} />,
  ...
  const waveOption: EChartsOption = useMemo(
    () => ({
      title: {
        text: 'Burn Rate vs Reorder Point',
        left: 'center',
        top: 0,
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                  {REORDER_PLAN.map((row) => (
                    <tr key={row.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                      ...
                      <td
                        className={`px-5 py-3 text-end font-bold ${row.stock <= row.reorderPt ? 'text-red-500' : 'text-gray-600'}`}
                      >
                        {row.stock}
                      </td>
