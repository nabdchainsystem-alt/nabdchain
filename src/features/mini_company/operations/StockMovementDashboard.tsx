...
const TOP_KPIS: (KPIConfig & { rawValue?: number, isCurrency?: boolean, color?: string })[] = [
    { id: '1', label: 'Stock In Qty', subtitle: 'Received', value: '4,500', change: '+12%', trend: 'up', icon: <ArrowDownLeft size={18} />, sparklineData: [3500, 3800, 4000, 4100, 4300, 4500], color: 'emerald' },
    ...
    { id: '3', label: 'Net Movement', subtitle: 'Balance', value: '+400', change: '+20%', trend: 'up', icon: <ArrowsLeftRight size={18} />, sparklineData: [200, 250, 300, 350, 380, 400], color: 'indigo' },
    { id: '4', label: 'Movement Frequency', subtitle: 'Trans/Day', value: '145', change: '-5', trend: 'down', icon: <Activity size={18} />, sparklineData: [150, 155, 148, 146, 142, 145], color: 'violet' },
];

const SIDE_KPIS: (KPIConfig & { rawValue?: number, isCurrency?: boolean, color?: string })[] = [
    { id: '5', label: 'Bottleneck Items', subtitle: 'Slow Processing', value: '12', change: '+2', trend: 'down', icon: <Clock size={18} />, sparklineData: [10, 10, 11, 11, 12, 12], color: 'amber' },
    { id: '6', label: 'Avg Daily Movement', subtitle: 'Unit Volume', value: '850', change: '+50', trend: 'up', icon: <TrendUp size={18} />, sparklineData: [750, 780, 800, 820, 840, 850], color: 'cyan' },
    { id: '7', label: 'Movement Volatility', subtitle: 'Std Dev', value: 'High', change: '', trend: 'neutral', icon: <Warning size={18} />, sparklineData: [10, 20, 15, 25, 10, 30], color: 'rose' },
];
    ...
    return (
        <div className="p-6 bg-white dark:bg-monday-dark-surface min-h-full font-sans text-gray-800 dark:text-gray-200 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="h-[200px] w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={IN_OUT_BY_CATEGORY} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                                        ...
                                        <Bar dataKey="in" name="Stock In" fill="#10b981" radius={[4, 4, 0, 0]} barSize={12} />
                ...
                {isLoading ? (
                    <div className="col-span-1 md:col-span-2 lg:col-span-2">
                        <ChartSkeleton height="h-[340px]" title="Inventory Flow Path" />
                    </div>
                ) : (
