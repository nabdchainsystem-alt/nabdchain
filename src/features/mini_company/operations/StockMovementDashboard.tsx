...
export const StockMovementDashboard: React.FC = () => {
  ...
  const TOP_KPIS = useMemo<(KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[]>(
    () => [
      {
        id: '1',
        label: t('stock_in_qty'),
        subtitle: t('received'),
        value: '4,500',
        change: '+12%',
        trend: 'up',
        icon: <ArrowDownLeft size={18} />,
        sparklineData: [3500, 3800, 4000, 4100, 4300, 4500],
        color: 'blue',
      },
      {
        id: '2',
        label: t('stock_out_qty'),
        subtitle: t('shipped'),
        value: '4,100',
        change: '+8%',
        trend: 'up',
        icon: <ArrowUpRight size={18} />,
        sparklineData: [3800, 3900, 3950, 4000, 4050, 4100],
        color: 'blue',
      },
      {
        id: '3',
        label: t('net_movement'),
        subtitle: t('balance'),
        value: '+400',
        change: '+20%',
        trend: 'up',
        icon: <ArrowsLeftRight size={18} />,
        sparklineData: [200, 250, 300, 350, 380, 400],
        color: 'blue',
      },
      {
        id: '4',
        label: t('movement_frequency'),
        subtitle: t('trans_per_day'),
        value: '145',
        change: '-5',
        trend: 'down',
        icon: <Activity size={18} />,
        sparklineData: [150, 155, 148, 146, 142, 145],
        color: 'blue',
      },
    ],
    [t],
  ...
  const SIDE_KPIS = useMemo<(KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[]>(
    () => [
      {
        id: '5',
        label: t('bottleneck_items'),
        subtitle: t('slow_processing'),
        value: '12',
        change: '+2',
        trend: 'down',
        icon: <Clock size={18} />,
      ...
      {
        id: '6',
        label: t('avg_daily_movement'),
        subtitle: t('unit_volume'),
        value: '850',
        change: '+50',
        trend: 'up',
        icon: <TrendUp size={18} />,
        sparklineData: [750, 780, 800, 820, 840, 850],
        color: 'blue',
      },
      {
        id: '7',
        label: t('movement_volatility'),
        subtitle: t('std_dev'),
        value: t('high'),
        change: '',
        trend: 'neutral',
        icon: <Warning size={18} />,
        sparklineData: [10, 20, 15, 25, 10, 30],
        color: 'blue',
      },
      {
        id: '8',
        label: t('transfer_efficiency'),
        subtitle: t('on_time_pct'),
        value: '94.5%',
        change: '+1.2%',
        trend: 'up',
        icon: <Activity size={18} />,
        sparklineData: [91, 92, 92.5, 93, 93.8, 94.5],
        color: 'blue',
      },
    ],
    [t],
