...
export const PurchaseBehaviorDashboard: React.FC = () => {
    ...
    () => [
      {
        ...
        subtitle: t('orders_per_month'),
        value: '18.5',
        change: '+2.1',
        trend: 'up',
        icon: <Timer size={18} color="#3b82f6" />,
        sparklineData: [15, 16, 16, 17, 18, 18, 18.5],
      },
      {
        id: '2',
        label: t('repeat_purchase_rate'),
        subtitle: t('recurring_items'),
        value: '42%',
        change: '+5%',
        trend: 'up',
        icon: <ArrowsOut size={18} color="#3b82f6" />,
        sparklineData: [35, 36, 38, 40, 41, 41, 42],
      },
      {
        id: '3',
        label: t('seasonal_index'),
        subtitle: t('peak_deviation'),
        value: '1.2x',
        change: '0',
        trend: 'neutral',
        icon: <CalendarIcon size={18} color="#3b82f6" />,
        sparklineData: [1, 1, 1.1, 1.2, 1.2, 1.1, 1.2],
      },
      {
        id: '4',
        label: t('category_concentration'),
        subtitle: t('top_3_share'),
        value: '68%',
        change: '-2%',
        trend: 'down',
        icon: <ChartPie size={18} color="#3b82f6" />,
        sparklineData: [72, 71, 70, 70, 69, 68, 68],
      },
    ],
    [t],
  );
  ...
  const SIDE_KPIS = useMemo<KPIData[]>(
    () => [
      {
        id: '5',
        label: t('avg_order_gap'),
        subtitle: t('days_between'),
        value: '4.2d',
        change: '-0.3d',
        trend: 'up',
        icon: <Timer size={18} color="#3b82f6" />,
        sparklineData: [5, 4.8, 4.6, 4.5, 4.3, 4.2, 4.2],
      },
      {
        id: '6',
        label: t('spike_detection'),
        subtitle: t('anomalies'),
        value: '3',
        change: '+1',
        trend: 'down',
        icon: <Lightning size={18} color="#3b82f6" />,
        sparklineData: [1, 1, 2, 0, 1, 2, 3],
      },
      {
        id: '7',
        label: t('irregular_purchases'),
        subtitle: t('out_of_pattern'),
        value: '5.4%',
        change: '-1.1%',
        trend: 'up',
        icon: <Waves size={18} color="#3b82f6" />,
        sparklineData: [7, 6.5, 6, 5.8, 5.5, 5.4, 5.4],
      },
      {
        id: '8',
        label: t('peak_purchase_day'),
        subtitle: t('highest_activity'),
        value: t('tuesday'),
        change: t('consistent'),
        trend: 'neutral',
        icon: <CalendarIcon size={18} color="#3b82f6" />,
        sparklineData: [8, 12, 15, 10, 9, 7, 5],
      },
    ],
    [t],
  );
    ...
    () => ({
      tooltip: {
        ...
        formatter: (params: CallbackDataParams | CallbackDataParams[]) => {
          ...
          return `${p.name}: ${formatCurrency(p.value as number, currency.code, currency.symbol)} (${p.percent}%)`;
        },
      },
      legend: {
        orient: 'horizontal',
      ...
      series: [
        {
          ...
          data: CATEGORY_MIX.map((d) => ({
            ...d,
            itemStyle: { color: d.name === 'Services' ? '#3b82f6' : undefined },
          })),
        },
      ],
    }),
  ...
  const heatmapOption = useMemo<EChartsOption>(
    () => ({
      title: {
        text: 'Weekly Purchasing Intensity',
        left: 'center',
        top: 0,
