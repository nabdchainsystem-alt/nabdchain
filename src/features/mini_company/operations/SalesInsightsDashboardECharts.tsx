...
export const SalesInsightsDashboardECharts: React.FC = memo(() => {
  ...
  const salesByChannelOption: EChartsOption = {
    ...
    yAxis: {
      type: 'category',
      data: SALES_BY_CHANNEL_DATA.map((d) => d.name),
      axisLine: { show: true },
      axisTick: { show: false },
    },
    series: [
  ...
  return (
    <div
      ref={containerRef}
      className={`p-6 bg-white dark:bg-monday-dark-surface min-h-full font-sans text-gray-800 dark:text-gray-200 relative ${isFullScreen ? 'overflow-y-auto' : ''}`}
    >
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1.5">
              Comprehensive sales data visualization using ECharts engine
            </p>
          </div>
        </div>
        ...
        <div className="col-span-1 lg:col-span-3 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-monday-dark-elevated p-5 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 h-full">
              <h3 className="text-sm font-semibold text-gray-500 mb-5 uppercase tracking-wider">
