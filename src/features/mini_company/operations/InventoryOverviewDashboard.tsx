...
const TOP_KPIS: (KPIConfig & { rawValue?: number, isCurrency?: boolean, color?: string })[] = [
    { id: '1', label: 'Total Stock Value', subtitle: 'Current Holdings', value: '$245k', rawValue: 245000, isCurrency: true, change: '+2.4%', trend: 'up', icon: <CurrencyDollar size={18} />, sparklineData: [230, 235, 238, 240, 242, 245], color: 'emerald' },
    ...
    { id: '3', label: 'In-Stock Rate', subtitle: 'Availability', value: '98.5%', change: '-0.2%', trend: 'down', icon: <CheckCircle size={18} />, sparklineData: [99, 99, 98.8, 98.6, 98.5, 98.5], color: 'cyan' },
    { id: '4', label: 'Out-of-Stock Items', subtitle: 'Stockouts', value: '18', change: '+3', trend: 'down', icon: <Warning size={18} />, sparklineData: [15, 15, 16, 17, 18, 18], color: 'rose' },
];

const SIDE_KPIS: (KPIConfig & { rawValue?: number, isCurrency?: boolean, color?: string })[] = [
    { id: '5', label: 'Low Stock Alerts', subtitle: '< Reorder Point', value: '42', change: '-5', trend: 'up', icon: <Warning size={18} />, sparklineData: [50, 48, 46, 45, 43, 42], color: 'amber' },
    { id: '6', label: 'Avg Inventory Age', subtitle: 'Days Held', value: '45d', change: '+2d', trend: 'down', icon: <Clock size={18} />, sparklineData: [40, 41, 42, 43, 44, 45], color: 'indigo' },
    { id: '7', label: 'Inventory Turnover', subtitle: 'Turns / Year', value: '4.2', change: '+0.1', trend: 'up', icon: <ChartBar size={18} />, sparklineData: [3.8, 3.9, 4.0, 4.1, 4.1, 4.2], color: 'violet' },
];
    ...
    return (
        <div className="p-6 bg-white dark:bg-monday-dark-surface min-h-full font-sans text-gray-800 dark:text-gray-200 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {TOP_KPIS.map((kpi) => (
                    <div key={kpi.id} className="col-span-1">
                        <KPICard
                            ...
                            color={kpi.color as any || 'emerald'}
                            loading={isLoading}
                        />
                    </div>
                ))}
                ...
                {isLoading ? (
                    <ChartSkeleton height="h-[380px]" title="Inventory Density" />
                ) : (
