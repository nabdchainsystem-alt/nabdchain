...
export const StockAccuracyDashboard: React.FC = () => {
  const { _currency, t, dir } = useAppContext();
  const isRTL = dir === 'rtl';
  ...
  const TOP_KPIS = useMemo(
    () => [
      {
        id: '1',
        label: t('stock_accuracy'),
        subtitle: t('audit_match_pct'),
        value: '98.2%',
        change: '+0.5%',
        trend: 'up' as const,
        icon: <Target size={18} />,
        sparklineData: [96, 97, 97.5, 98, 98.1, 98.2],
        color: 'blue',
      },
      {
        id: '2',
        label: t('shrinkage_value'),
        subtitle: t('lost_inventory'),
        value: '0',
        rawValue: 8200,
        isCurrency: true,
        change: '-5.0%',
        ...
        sparklineData: [9, 8.8, 8.6, 8.5, 8.3, 8.2],
        color: 'blue',
      },
      {
        id: '3',
        label: t('adjustment_count'),
        subtitle: t('manual_fixes'),
        value: '142',
        change: '-10',
        trend: 'up' as const,
        icon: <Lightning size={18} />,
        sparklineData: [160, 155, 150, 148, 145, 142],
        color: 'blue',
      },
      {
        id: '4',
        label: t('loss_rate'),
        subtitle: t('pct_of_total_value'),
        value: '0.45%',
        change: '-0.02%',
        trend: 'up' as const,
        icon: <XCircle size={18} />,
        sparklineData: [0.5, 0.49, 0.48, 0.47, 0.46, 0.45],
        color: 'blue',
      },
    ],
    [t],
  ...
  const SIDE_KPIS = useMemo(
    () => [
      {
        id: '5',
        label: t('high_risk_skus'),
        subtitle: t('frequent_losses'),
        value: '18',
        change: '-2',
        trend: 'up' as const,
        icon: <Warning size={18} />,
        sparklineData: [20, 20, 19, 19, 18, 18],
        color: 'blue',
      },
      {
        id: '6',
        label: t('audit_frequency'),
        subtitle: t('days_per_cycle'),
        value: '30d',
        change: '0d',
        trend: 'neutral' as const,
        icon: <FileSearch size={18} />,
        sparklineData: [30, 30, 30, 30, 30, 30],
        color: 'blue',
      },
      {
        id: '7',
        label: t('variance_alerts'),
        subtitle: t('open_issues'),
        value: '5',
        change: '-3',
        trend: 'up' as const,
        icon: <ShieldCheck size={18} />,
        sparklineData: [8, 7, 7, 6, 6, 5],
        color: 'blue',
      },
      {
        id: '8',
        label: t('recovery_rate'),
        subtitle: t('found_items_pct'),
        value: '72%',
        change: '+5%',
        trend: 'up' as const,
        icon: <ChartLine size={18} />,
        sparklineData: [60, 63, 66, 68, 70, 72],
        color: 'blue',
      },
    ],
    [t],
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                  {VARIANCE_LOG.map((row) => (
                    <tr key={row.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                      ...
                      <td
                        className={`px-5 py-3 text-end font-bold ${row.variance < 0 ? 'text-red-500' : 'text-emerald-500'}`}
                      >
