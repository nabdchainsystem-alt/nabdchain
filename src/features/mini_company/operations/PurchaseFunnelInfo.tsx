...
import { X, CaretRight, CaretDown, Funnel, Table as TableIcon, Calculator } from 'phosphor-react';
...
export const PurchaseFunnelInfo: React.FC<PurchaseFunnelInfoProps> = ({ isOpen, onClose }) => {
    ...
    const questions = [
        { q: t('pf_info_q1'), a: t('pf_info_a1') },
        { q: t('pf_info_q2'), a: t('pf_info_a2') },
        { q: t('pf_info_q3'), a: t('pf_info_a3') },
        { q: t('pf_info_q4'), a: t('pf_info_a4') },
        { q: t('pf_info_q5'), a: t('pf_info_a5') }
    ];
            ...
            >
                <div className="flex-none flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-monday-dark-surface z-10 text-start">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{t('pf_info_subtitle')}</p>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('requests_submitted')} desc={t('pf_info_requests_desc')} />
                                    <DetailItem title={t('approved_requests')} desc={t('pf_info_approved_desc')} />
                                    <DetailItem title={t('rejected_requests')} desc={t('pf_info_rejected_desc')} />
                                    <DetailItem title={t('avg_approval_time')} desc={t('pf_info_approval_time_desc')} />
                                    <DetailItem title={t('approval_rate')} desc={t('pf_info_approval_rate_desc')} />
                                    <DetailItem title={t('bottleneck_stage')} desc={t('pf_info_bottleneck_desc')} />
                                    <DetailItem title={t('delayed_requests')} desc={t('pf_info_delayed_desc')} />
                                    <DetailItem title={t('sla_compliance')} desc={t('pf_info_sla_desc')} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('request_funnel')} desc={t('pf_info_funnel_chart_desc')} />
                                    <DetailItem title={t('avg_hours_per_stage')} desc={t('pf_info_hours_chart_desc')} />
                                    <DetailItem title={t('request_volume_trend')} desc={t('pf_info_volume_chart_desc')} />
                                    <DetailItem title={t('stage_status_distribution')} desc={t('pf_info_status_chart_desc')} />
                                    <DetailItem title={t('request_status_table')} desc={t('pf_info_status_table_desc')} />
                                    <DetailItem title={t('approval_flow_sankey')} desc={t('pf_info_sankey_desc')} />
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-4">
                                    <TableSchema
                                        name={t('pf_table_requests')}
                                        desc={t('pf_table_requests_desc')}
                                        columns={[t('request_id'), t('requester'), t('submission_date'), t('status')]}
                                    />
                                    <TableSchema
                                        name={t('pf_table_approval_logs')}
                                        desc={t('pf_table_approval_logs_desc')}
                                        columns={[t('log_id'), t('request_id'), t('stage'), t('action_date'), t('outcome')]}
                                    />
                                    <TableSchema
                                        name={t('pf_table_workflows')}
                                        desc={t('pf_table_workflows_desc')}
                                        columns={[t('stage_name'), t('sla_days'), t('approver_role')]}
                                    />
                                </div>
                            </div>
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-xl border border-blue-100 dark:border-blue-800/30">
                                ...
                                <ul className="space-y-2.5 text-xs text-blue-900/80 dark:text-blue-200/80 ms-1">
                                    <li className="flex gap-2 text-start">
                                        ...
                                        <span><strong>{t('approval_time')}:</strong> {t('pf_calc_approval_time')}</span>
                                    </li>
                                    <li className="flex gap-2 text-start">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" />
                                        <span><strong>{t('delayed')}:</strong> {t('pf_calc_delayed')}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
