...
export const InventoryForecastDashboard: React.FC = () => {
  ...
  const TOP_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = [
    {
      id: '1',
      label: t('forecast_demand'),
      subtitle: t('next_30_days'),
      value: '12,500',
      change: '+8%',
      trend: 'up',
      icon: <TrendUp size={18} />,
      sparklineData: [11000, 11500, 11800, 12000, 12200, 12500],
      color: 'blue',
    },
    {
      id: '2',
      label: t('forecast_accuracy'),
      subtitle: t('model_fit'),
      value: '94%',
      change: '+1%',
      trend: 'up',
    ...
    },
    {
      ...
      subtitle: t('pct_vulnerable'),
      value: '12%',
      change: '-2%',
      trend: 'down',
      icon: <Warning size={18} />,
      sparklineData: [15, 14, 14, 13, 13, 12],
      color: 'blue',
    },
    {
      id: '4',
      label: t('expected_stockouts'),
      subtitle: t('predicted'),
      value: '8',
      change: '-1',
      trend: 'down',
      icon: <Lightning size={18} />,
      sparklineData: [10, 9, 9, 9, 8, 8],
      color: 'blue',
    },
  ];
  ...
  const SIDE_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = [
    {
      id: '5',
      label: t('overstock_risk'),
      subtitle: t('potential_excess'),
      value: '25',
      change: '+3',
      trend: 'up',
    ...
    {
      id: '6',
      label: t('supply_volatility'),
      subtitle: t('supplier_var'),
      value: t('low'),
      change: '',
      trend: 'neutral',
      icon: <Warning size={18} />,
      sparklineData: [1, 2, 1, 3, 1, 2],
      color: 'blue',
    },
    {
      id: '7',
      label: t('confidence_level'),
      subtitle: t('statistical'),
      value: '90%',
      change: '0%',
      trend: 'neutral',
    ...
    {
      id: '8',
      label: t('lead_time_avg'),
      subtitle: t('days_to_receive'),
      value: '8.5d',
      change: '-0.5d',
      trend: 'up',
      icon: <TrendUp size={18} />,
      sparklineData: [10, 9.5, 9.2, 9, 8.8, 8.5],
      color: 'blue',
    },
  ];
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                  {RISK_TABLE.map((row) => (
                    <tr key={row.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                      ...
                      <td className="px-5 py-3 text-xs font-medium text-gray-700 dark:text-gray-300 text-start">
