...
const _REVENUE_BY_SEGMENT_DATA = [
    ...
    () => [
      {
        ...
        subtitle: t('lifetime_registered_base'),
        value: '4,850',
        change: '+3.2%',
        trend: 'up' as const,
        icon: <Users size={18} />,
        sparklineData: [4200, 4350, 4480, 4580, 4680, 4780, 4850],
      },
      {
        id: '2',
        label: t('active_customers'),
        subtitle: t('last_90_days_activity'),
        value: '3,240',
        change: '+5.4%',
        trend: 'up' as const,
        icon: <Star size={18} />,
        sparklineData: [2800, 2920, 3020, 3080, 3140, 3200, 3240],
      },
      {
        id: '3',
        label: t('repeat_customer_percent'),
        subtitle: t('loyalty_retention_rate'),
        value: '64.2%',
        change: '+1.5%',
        trend: 'up' as const,
        icon: <Repeat size={18} />,
        sparklineData: [58, 59.5, 60.8, 62, 63, 63.8, 64.2],
      },
      {
        id: '4',
        label: t('avg_clv'),
        subtitle: t('est_lifetime_value'),
        value: '0',
        rawValue: 12450,
        isCurrency: true,
        change: '+8.4%',
        ...
        sparklineData: [10.2, 10.8, 11.2, 11.6, 12, 12.2, 12.45],
      },
    ],
    [t],
  );
    ...
    () => [
      {
        id: '5',
        label: t('avg_orders'),
        subtitle: t('per_customer_frequency'),
        value: '4.2',
        change: '+0.5',
        trend: 'up' as const,
        icon: <ChartLine size={18} />,
        sparklineData: [3.5, 3.7, 3.8, 3.9, 4, 4.1, 4.2],
      },
      {
        id: '6',
        label: t('churn_rate_percent'),
        subtitle: t('lost_customer_ratio'),
        value: '12.4%',
        change: '-0.8%',
        trend: 'up' as const,
        icon: <Warning size={18} />,
        sparklineData: [15, 14.5, 14, 13.5, 13, 12.8, 12.4],
      },
      {
        id: '7',
        ...
        trend: 'up' as const,
        icon: <Heart size={18} />,
        sparklineData: [68, 70, 72, 74, 75, 77, 78],
      },
      {
        id: '8',
        label: t('new_customers'),
        subtitle: t('monthly_acquisitions'),
        value: '186',
        change: '+12%',
        trend: 'up' as const,
        icon: <UserPlus size={18} />,
        sparklineData: [145, 152, 160, 168, 175, 180, 186],
      },
    ],
    [t],
  );
      ...
      tooltip: {
        ...
        formatter: (params: CallbackDataParams | CallbackDataParams[]) => {
          ...
          return `<div class="p-2 font-sans">
                    ...
                    <p class="text-xs text-gray-500 mt-1">${t('orders')}: ${d[0]}</p>
                    <p class="text-xs text-gray-500">${t('revenue')}: ${formatCurrency(d[1] as number, currency.code, currency.symbol)}</p>
                </div>`;
        },
      },
