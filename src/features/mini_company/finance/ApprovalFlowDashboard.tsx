...
const getTopKPIs = (
  ...
  },
  {
    ...
    trend: 'up',
    icon: <Clock size={18} />,
    sparklineData: [32, 30, 29, 29, 28, 28],
    color: 'blue',
  },
];
...
const getSideKPIs = (
...
): (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] => [
  {
    ...
    sparklineData: [5, 4, 6, 3, 3, 2],
    color: 'blue',
  },
  {
    id: '6',
    label: t('rejection_rate'),
    subtitle: t('percent_of_total'),
    value: '11%',
    change: '+1%',
    trend: 'down',
    icon: <Warning size={18} />,
    sparklineData: [10, 10, 12, 11, 10, 11],
    color: 'blue',
  },
  {
    id: '7',
    label: t('control_bottlenecks'),
    subtitle: t('slow_stages'),
    value: '1',
    change: '0',
    trend: 'neutral',
  ...
  {
    id: '8',
    label: t('approval_efficiency'),
    subtitle: t('success_rate'),
    value: '84%',
    change: '+3%',
    trend: 'up',
    icon: <TrendUp size={18} />,
    sparklineData: [78, 79, 81, 82, 83, 84],
    color: 'blue',
  },
];
      ...
      series: [
        {
          type: 'bar',
          name: 'Approved',
          data: APPROVALS_BY_TYPE.map((d) => d.Approved),
          itemStyle: { color: '#3b82f6', borderRadius: [4, 4, 0, 0] },
          barWidth: 12,
        },
        {
          type: 'bar',
          name: 'Rejected',
          data: APPROVALS_BY_TYPE.map((d) => d.Rejected),
