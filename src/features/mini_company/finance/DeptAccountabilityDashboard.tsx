...
const getTopKPIs = (
  ...
  {
    id: '2',
    label: t('highest_spending'),
    subtitle: t('engineering'),
    value: '0',
    rawValue: 120000,
    isCurrency: true,
    change: '+5%',
    ...
    sparklineData: [110, 115, 112, 118, 120, 120],
    color: 'blue',
  },
  {
    id: '3',
    ...
    sparklineData: [8, 9, 10, 11, 12, 12.5],
    color: 'blue',
  },
  {
    id: '4',
    label: t('avg_dept_expense'),
    ...
    trend: 'up',
    icon: <Target size={18} />,
    sparklineData: [42, 43, 44, 44, 45, 45],
    color: 'blue',
  },
];
...
const getSideKPIs = (
  ...
  {
    id: '5',
    label: t('over_budget_depts'),
    subtitle: t('red_flags'),
    value: '2',
    change: '+1',
    trend: 'down',
    icon: <Warning size={18} />,
    sparklineData: [1, 1, 0, 1, 1, 2],
    color: 'blue',
  },
  {
    id: '6',
    ...
    trend: 'up',
    icon: <Trophy size={18} />,
    sparklineData: [80, 82, 83, 84, 84, 85],
    color: 'blue',
  },
  {
    id: '7',
    label: t('accountability_index'),
    subtitle: t('compliance'),
    value: '92%',
    change: '0%',
    trend: 'neutral',
    icon: <ChartPieSlice size={18} />,
    sparklineData: [90, 91, 92, 92, 92, 92],
    color: 'blue',
  },
  {
    id: '8',
    label: t('cost_per_employee'),
    subtitle: t('avg_monthly'),
    value: '0',
    rawValue: 2850,
    isCurrency: true,
    change: '-2%',
    trend: 'down',
    icon: <UsersThree size={18} />,
    sparklineData: [3000, 2950, 2900, 2880, 2860, 2850],
    color: 'blue',
  },
];
      ...
      series: [
        {
          type: 'bar',
          name: 'Budget',
          data: BUDGET_VS_ACTUAL.map((d) => d.Budget),
        ...
        },
        {
          type: 'bar',
          name: 'Actual',
          data: BUDGET_VS_ACTUAL.map((d) => d.Actual),
          itemStyle: { color: '#3b82f6', borderRadius: [4, 4, 0, 0] },
          barWidth: 12,
        },
      ],
                ...
                {DEPT_PERFORMANCE.map((row, index) => (
                  <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                    ...
                    <td className="px-5 py-3 text-end text-gray-600 dark:text-gray-400">
                      {formatCurrency(row.rawBudget, currency.code, currency.symbol)}
                    </td>
                    ...
                    <td
                      className={`px-5 py-3 text-end font-medium ${row.rawVariance > 0 ? 'text-red-500' : 'text-green-500'}`}
                    >
                      {row.rawVariance > 0 ? '+' : ''}
                      {formatCurrency(row.rawVariance, currency.code, currency.symbol)}
                    </td>
