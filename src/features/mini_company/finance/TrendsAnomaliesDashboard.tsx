...
const TOP_KPIS: (KPIConfig & { rawValue?: number, isCurrency?: boolean, color?: string })[] = [
    { id: '1', label: 'Trend Direction', subtitle: 'Last 3 Months', value: 'Rising', change: '+5%', trend: 'up', icon: <TrendUp size={18} />, sparklineData: [40, 42, 45, 48, 50, 52], color: 'orange' },
    { id: '2', label: 'Spike Count', subtitle: 'Last 30 Days', value: '5', change: '+2', trend: 'up', icon: <Lightning size={18} />, sparklineData: [1, 0, 1, 0, 2, 1], color: 'red' },
    { id: '3', label: 'Anomaly Value', subtitle: 'Total Excess', value: '$4,250', change: '+12%', trend: 'down', icon: <Warning size={18} />, sparklineData: [1000, 1200, 800, 3000, 4250, 4250], color: 'rose' },
    { id: '4', label: 'Avg Monthly Change', subtitle: 'Volatility', value: '8.2%', change: '+1.5%', trend: 'neutral', icon: <Activity size={18} />, sparklineData: [5, 6, 8, 7, 8, 8.2], color: 'purple' },
];

const SIDE_KPIS: (KPIConfig & { rawValue?: number, isCurrency?: boolean, color?: string })[] = [
    { id: '5', label: 'Risk Level', subtitle: 'Assessment', value: 'Medium', change: '', trend: 'neutral', icon: <ShieldWarning size={18} />, sparklineData: [30, 30, 40, 50, 50, 50], color: 'amber' },
    { id: '6', label: 'Alert Frequency', subtitle: 'Avg per Week', value: '3.5', change: '-5%', trend: 'down', icon: <Lightning size={18} />, sparklineData: [4, 4, 3, 3, 4, 3.5], color: 'cyan' },
    { id: '7', label: 'Expense Stability', subtitle: 'Index Score', value: '72/100', change: '-2', trend: 'down', icon: <ChartLine size={18} />, sparklineData: [78, 76, 75, 74, 73, 72], color: 'teal' },
];
                        ...
                        <div className="h-[200px] w-full">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={MONTHLY_EXPENSES} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                                    ...
                                    <Bar dataKey="Anomaly" stackId="a" fill="#f87171" radius={[4, 4, 0, 0]} barSize={24} />
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
                    </div>
