...
const getTopKPIs = (
...
): (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] => [
  {
    ...
    trend: 'neutral',
    icon: <Lock size={18} />,
    sparklineData: [70, 70, 70, 70, 70, 70],
    color: 'blue',
  },
  {
    id: '2',
    label: t('variable_expenses'),
    ...
    sparklineData: [40, 42, 41, 44, 43, 45],
    color: 'blue',
  },
  {
    id: '3',
    label: t('flexibility_ratio'),
    subtitle: t('var_total'),
    value: '35%',
    change: '+1.5%',
    trend: 'up',
    icon: <ArrowDown size={18} />,
    sparklineData: [32, 33, 33, 34, 34, 35],
    color: 'blue',
  },
  {
    id: '4',
    label: t('fixed_cost_growth'),
    subtitle: t('yoy'),
    value: '2.1%',
    change: '-0.5%',
    trend: 'down',
    icon: <TrendUp size={18} />,
    sparklineData: [2.5, 2.4, 2.3, 2.2, 2.1, 2.1],
    color: 'blue',
  },
];
...
const getSideKPIs = (
  ...
  {
    id: '5',
    label: t('var_cost_volatility'),
    subtitle: t('std_dev'),
    value: t('high'),
    change: '',
    trend: 'neutral',
    icon: <Warning size={18} />,
    sparklineData: [60, 75, 50, 80, 65, 70],
    color: 'blue',
  },
  {
    id: '6',
    label: t('break_even_impact'),
    subtitle: t('revenue_needed'),
    value: '0',
    rawValue: 1200000,
    isCurrency: true,
    change: '0',
    ...
    sparklineData: [1.2, 1.2, 1.2, 1.2, 1.2, 1.2],
    color: 'blue',
  },
  {
    id: '7',
    label: t('cost_rigidity'),
    subtitle: t('fixed_total'),
    value: '65%',
    change: '-1.5%',
    trend: 'down',
    icon: <Lock size={18} />,
    sparklineData: [68, 67, 67, 66, 66, 65],
    color: 'blue',
  },
  {
    id: '8',
    label: t('optimization_score'),
    subtitle: t('cost_efficiency'),
    value: '78/100',
    change: '+4',
    trend: 'up',
    icon: <TrendUp size={18} />,
      ...
      series: [
        {
          ...
          name: 'Fixed',
          stack: 'total',
          data: FIXED_VAR_TREND.map((d) => d.Fixed),
        ...
        },
        {
          ...
          name: 'Variable',
          stack: 'total',
          data: FIXED_VAR_TREND.map((d) => d.Variable),
    ...
    () => ({
      ...
      tooltip: {
        formatter: (params: CallbackDataParams | CallbackDataParams[]) => {
          ...
          return `<b>${val[2]}</b><br/>${t('impact')}: ${val[0]}<br/>${t('rigidity')}: ${val[1]}<br/>${t('type')}: ${val[3]}`;
        },
      },
      ...
      series: [
        {
          ...
          itemStyle: {
            color: (params: CallbackDataParams) => {
              const type = (params.value as unknown[])[3];
