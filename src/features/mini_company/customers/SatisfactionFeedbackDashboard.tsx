...
export const SatisfactionFeedbackDashboard: React.FC = () => {
    ...
    () => [
      {
        id: '1',
        label: t('csat_score'),
        subtitle: t('customer_satisfaction'),
        value: '8.4',
        change: '+0.2',
        trend: 'up',
        icon: <Star size={18} />,
        sparklineData: [8.0, 8.1, 8.2, 8.3, 8.3, 8.4],
        color: 'blue',
      },
      {
        id: '2',
        label: t('nps_score'),
        subtitle: t('net_promoter'),
        value: '+42',
        change: '+5',
        trend: 'up',
        icon: <Smiley size={18} />,
        sparklineData: [35, 36, 38, 40, 41, 42],
        color: 'blue',
      },
      {
        id: '3',
        label: t('feedback_count'),
        subtitle: t('total_reviews'),
        value: '350',
        change: '+10%',
        trend: 'up',
      ...
      {
        id: '4',
        label: t('positive_percentage'),
        subtitle: t('star_rating'),
        value: '78%',
        change: '+2%',
        trend: 'up',
        icon: <ThumbsUp size={18} />,
        sparklineData: [75, 76, 76, 77, 77, 78],
        color: 'blue',
      },
    ],
    [t],
  ...
  const SIDE_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = useMemo(
    () => [
      {
        id: '5',
        label: t('negative_percentage'),
        subtitle: t('low_ratings'),
        value: '8%',
        change: '-1%',
        trend: 'down',
        icon: <ThumbsDown size={18} />,
        sparklineData: [10, 9, 9, 8, 8, 8],
        color: 'blue',
      },
      {
        id: '6',
        label: t('response_rate'),
        subtitle: t('survey_participation'),
        value: '22%',
        change: '+3%',
        trend: 'up',
        icon: <Megaphone size={18} />,
        sparklineData: [18, 19, 20, 21, 21, 22],
        color: 'blue',
      },
      {
        id: '7',
        label: t('sentiment_index'),
        subtitle: t('ai_analysis'),
        value: '72',
        change: '+4',
        trend: 'up',
        icon: <TrendUp size={18} />,
        sparklineData: [65, 66, 68, 70, 71, 72],
        color: 'blue',
      },
      {
        id: '8',
        label: t('avg_response_time'),
        subtitle: t('feedback_resolution'),
        value: '4.2h',
        change: '-0.5h',
        trend: 'up',
        icon: <ChatCenteredText size={18} />,
        sparklineData: [5.5, 5.2, 4.9, 4.6, 4.4, 4.2],
        color: 'blue',
      },
    ],
    [t],
  ...
  const FEEDBACK_LOG = useMemo(
    () =>
      FEEDBACK_LOG_RAW.map((item) => ({
        ...item,
        type: t(item.typeKey),
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                    {FEEDBACK_LOG.map((row, index) => (
                      <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                        ...
                        <td className="px-5 py-3 font-medium text-gray-800 dark:text-gray-200 text-start">
                          {row.score}
                        </td>
                        <td className="px-5 py-3 text-gray-500 dark:text-gray-500 text-xs font-datetime text-start">
                          {row.date}
                        </td>
                        <td className="px-5 py-3 text-end">
                          <span
                            className={`inline-flex px-2 py-0.5 rounded text-[10px] font-bold ${
                              row.statusKey === 'closed'
                                ? 'bg-green-100 text-green-700'
                                : row.statusKey === 'escalated'
