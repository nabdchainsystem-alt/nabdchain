...
import { X, Info, CaretRight, CaretDown, Activity } from 'phosphor-react';
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('purchase_frequency_label')}
                    desc={t('purchase_frequency_label_desc')}
                    isRTL={isRTL}
                  />
