...
export const CustomerOverviewInfo: React.FC<CustomerOverviewInfoProps> = ({ isOpen, onClose }) => {
    ...
    const questions = [
        { q: t('customer_overview_q1'), a: t('customer_overview_a1') },
        { q: t('customer_overview_q2'), a: t('customer_overview_a2') },
        { q: t('customer_overview_q3'), a: t('customer_overview_a3') },
        { q: t('customer_overview_q4'), a: t('customer_overview_a4') }
    ];
                ...
                <div className="flex-none flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-monday-dark-surface z-10">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                            ...
                            {t('customer_overview_title')}
                        </h2>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{t('customer_overview_subtitle')}</p>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('total_customers')} desc={t('total_customers_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('active_customers')} desc={t('active_customers_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('new_customers')} desc={t('new_customers_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('churned')} desc={t('churned_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('avg_revenue_user')} desc={t('avg_revenue_user_desc')} isRTL={isRTL} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('customers_by_month')} desc={t('customers_by_month_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('customer_distribution')} desc={t('customer_distribution_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('customer_list')} desc={t('customer_list_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('value_density')} desc={t('value_density_desc')} isRTL={isRTL} />
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="space-y-6">
                            <div>
                                <div className="flex items-center gap-2 mb-4 text-gray-800 dark:text-gray-200 font-semibold text-xs uppercase tracking-wide">
                                    ...
                                    <span>{t('info_cohorts')}</span>
                                </div>

                                <div className="space-y-4">
                                    <div className="bg-gray-50 dark:bg-gray-800/30 rounded-lg border border-gray-100 dark:border-gray-700 p-3">
                                        <div className="font-bold text-xs text-gray-800 dark:text-gray-200 mb-1">{t('info_segment_definition')}</div>
                                        <p className="text-[10px] text-gray-500 dark:text-gray-400">{t('segment_definition_desc')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
