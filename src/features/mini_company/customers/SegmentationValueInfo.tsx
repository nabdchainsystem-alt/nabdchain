...
export const SegmentationValueInfo: React.FC<SegmentationValueInfoProps> = ({ isOpen, onClose }) => {
    ...
    const questions = [
        { q: t('segmentation_info_q1'), a: t('segmentation_info_a1') },
        { q: t('segmentation_info_q2'), a: t('segmentation_info_a2') },
        { q: t('segmentation_info_q3'), a: t('segmentation_info_a3') },
        { q: t('segmentation_info_q4'), a: t('segmentation_info_a4') }
    ];
                ...
                <div className="flex-none flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-monday-dark-surface z-10">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                            ...
                            {t('segmentation_value_title')}
                        </h2>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{t('segmentation_subtitle')}</p>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('tier_counts')} desc={t('tier_counts_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('clv_label')} desc={t('clv_label_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('revenue_concentration')} desc={t('revenue_concentration_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('segment_growth_label')} desc={t('segment_growth_label_desc')} isRTL={isRTL} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('revenue_per_segment')} desc={t('revenue_per_segment_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('segment_share')} desc={t('segment_share_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('value_vs_frequency')} desc={t('value_vs_frequency_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('top_customers')} desc={t('top_customers_desc')} isRTL={isRTL} />
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="space-y-6">
                            <div>
                                <div className="flex items-center gap-2 mb-4 text-gray-800 dark:text-gray-200 font-semibold text-xs uppercase tracking-wide">
                                    ...
                                    <span>{t('info_tiers')}</span>
                                </div>

                                <div className="space-y-4">
                                    <div className="bg-gray-50 dark:bg-gray-800/30 rounded-lg border border-gray-100 dark:border-gray-700 p-3">
                                        <div className="font-bold text-xs text-gray-800 dark:text-gray-200 mb-1">{t('rfm_model')}</div>
                                        <p className="text-[10px] text-gray-500 dark:text-gray-400">{t('rfm_model_desc')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
