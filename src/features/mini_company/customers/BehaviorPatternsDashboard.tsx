...
export const BehaviorPatternsDashboard: React.FC = () => {
  ...
  const TOP_KPIS = useMemo<(KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[]>(
    () => [
      {
        id: '1',
        label: t('avg_orders_customer'),
        subtitle: t('per_year'),
        value: '4.2',
        change: '+0.2',
        trend: 'up',
        icon: <ShoppingCart size={18} />,
        sparklineData: [3.8, 3.9, 4, 4.1, 4.2, 4.2],
        color: 'blue',
      },
      {
        id: '2',
        ...
        trend: 'up',
        icon: <Clock size={18} />,
        sparklineData: [48, 47, 46, 46, 45, 45],
        color: 'blue',
      },
      {
        id: '3',
        label: t('avg_basket_size'),
        subtitle: t('items_per_order'),
        value: '3.5',
        change: '+0.1',
        trend: 'up',
        icon: <ShoppingCart size={18} />,
        sparklineData: [3.2, 3.3, 3.4, 3.4, 3.5, 3.5],
        color: 'blue',
      },
      {
        id: '4',
        label: t('repeat_rate'),
        subtitle: t('percent_returning'),
        value: '65%',
        change: '+2%',
        trend: 'up',
        icon: <TrendUp size={18} />,
        sparklineData: [60, 61, 62, 63, 64, 65],
        color: 'blue',
      },
    ],
    [t],
    ...
    () => [
      {
        ...
        subtitle: t('buying_intensity'),
        value: '1.2x',
        change: '+0.1',
        trend: 'up',
        icon: <Activity size={18} />,
        sparklineData: [1, 1, 1.1, 1.1, 1.2, 1.2],
        color: 'blue',
      },
      {
        id: '6',
        label: t('behavior_volatility'),
        subtitle: t('pattern_variance'),
        value: t('low'),
        change: '',
        trend: 'neutral',
      ...
      {
        id: '7',
        label: t('pattern_alerts'),
        subtitle: t('anomalies'),
        value: '3',
        change: '+1',
        trend: 'down',
        icon: <Lightning size={18} />,
        sparklineData: [1, 2, 2, 2, 3, 3],
        color: 'blue',
      },
      {
        id: '8',
        label: t('peak_purchase_hour'),
        subtitle: t('most_active_time'),
        value: '2 PM',
        change: t('stable'),
        trend: 'neutral',
        icon: <Clock size={18} />,
        sparklineData: [14, 14, 14, 14, 14, 14],
        color: 'blue',
      },
    ],
    [t],
  ...
  const BEHAVIOR_LOG = useMemo(
    () =>
      BEHAVIOR_LOG_DATA.map((row) => ({
        ...row,
                  ...
                  {BEHAVIOR_LOG.map((row, index) => (
                    <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                      ...
                      <td className="px-5 py-3 text-end text-green-600 font-medium">
                        {formatCurrency(row.rawAov, currency.code, currency.symbol)}
                      </td>
                      <td className="px-5 py-3 text-end text-gray-500 dark:text-gray-400 text-xs">{row.lastDate}</td>
                      <td className="px-5 py-3 text-center">
                        <span
                          className={`inline-flex px-2 py-0.5 rounded text-[10px] font-bold ${getTrendClass(row.trendKey)}`}
                        >
                          {row.trend}
                        </span>
                      </td>
