...
import { X, Info, CaretRight, CaretDown, Truck, Factory, Money, Star } from 'phosphor-react';
...
export const SupplierOverviewInfo: React.FC<SupplierOverviewInfoProps> = ({ isOpen, onClose }) => {
    ...
    const questions = [
        { q: 'What defines an "Active Supplier"?', a: 'Suppliers with at least one active purchase order or transaction in the last 6 months.' },
        { q: 'How is "Supplier Rating" calculated?', a: 'A weighted average of delivery performance (40%), quality metrics (30%), and pricing/cost adherence (30%).' },
        { q: 'What does "Total Supplier Spend" include?', a: 'The aggregated value of all approved purchase orders and direct expenses attributed to suppliers year-to-date.' },
        { q: 'How is "Supplier Risk" determined?', a: 'Based on geographic stability, financial health reports, and dependency concentration (single vs multi-source).' }
    ];
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 text-gray-600 dark:text-gray-300 pb-24">
                    <section>
                        ...
                        <p className="text-sm leading-relaxed p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-700">
                            This dashboard provides a consolidated view of the supplier base, tracking key metrics such as total spend, engagement levels, and overall performance ratings to support strategic sourcing decisions.
                        </p>
                    </section>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title="Total Suppliers" desc="Count of all registered vendor profiles." />
                                    <DetailItem title="Active Suppliers" desc="Vendors engaged in current transactions." />
                                    <DetailItem title="Total Spend" desc="Cumulative procurement expenditure." />
                                    <DetailItem title="Avg Rating" desc="Overall quality and delivery score." />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title="Spend by Supplier" desc="Top vendors by financial volume." />
                                    <DetailItem title="Category Distribution" desc="Supplier spread across industries." />
                                    <DetailItem title="Supplier Matrix" desc="Bubble chart of Spend vs Rating vs Risk." />
                                    <DetailItem title="Growth Trend" desc="New supplier onboarding over time." />
                                </div>
                            </div>
                        </div>
                    </section>
