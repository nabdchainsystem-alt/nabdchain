...
export const SupplierOverviewInfo: React.FC<SupplierOverviewInfoProps> = ({ isOpen, onClose }) => {
    ...
    const questions = [
        { q: t('supplier_overview_q1'), a: t('supplier_overview_a1') },
        { q: t('supplier_overview_q2'), a: t('supplier_overview_a2') },
        { q: t('supplier_overview_q3'), a: t('supplier_overview_a3') },
        { q: t('supplier_overview_q4'), a: t('supplier_overview_a4') }
    ];
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('supplier_total_suppliers')} desc={t('supplier_total_suppliers_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_active_suppliers')} desc={t('supplier_active_suppliers_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('total_spend')} desc={t('supplier_total_spend_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_avg_rating')} desc={t('supplier_avg_rating_desc')} isRTL={isRTL} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('supplier_spend_by_supplier')} desc={t('supplier_spend_by_supplier_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_category_distribution')} desc={t('supplier_category_distribution_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_matrix')} desc={t('supplier_matrix_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_growth_trend')} desc={t('supplier_growth_trend_desc')} isRTL={isRTL} />
                                </div>
                            </div>
                        </div>
                    </section>
