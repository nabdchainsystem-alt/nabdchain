...
import { X, Info, CaretRight, CaretDown } from 'phosphor-react';
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_total_suppliers')}
                    desc={t('supplier_total_suppliers_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_active_suppliers')}
                    desc={t('supplier_active_suppliers_desc')}
                    isRTL={isRTL}
                  />
              ...
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_spend_by_supplier')}
                    desc={t('supplier_spend_by_supplier_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_category_distribution')}
                    desc={t('supplier_category_distribution_desc')}
                    isRTL={isRTL}
                  />
