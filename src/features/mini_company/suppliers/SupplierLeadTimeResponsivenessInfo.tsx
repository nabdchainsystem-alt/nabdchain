...
export const SupplierLeadTimeResponsivenessInfo: React.FC<SupplierLeadTimeResponsivenessInfoProps> = ({
  isOpen,
  onClose,
}) => {
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <DetailItem
                    title={t('supplier_fastest_supplier')}
                    desc={t('supplier_fastest_supplier_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_response_time_rfq')}
                    desc={t('supplier_response_time_rfq_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_leadtime_variance')}
                    desc={t('supplier_leadtime_variance_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_leadtime_distribution')}
                    desc={t('supplier_leadtime_distribution_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_response_speed')}
                    desc={t('supplier_response_speed_desc')}
                    isRTL={isRTL}
                  />
