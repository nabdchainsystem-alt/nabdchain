            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <DetailItem
                    title={t('supplier_quality_score')}
                    desc={t('supplier_quality_score_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_compliance_score')}
                    desc={t('supplier_compliance_score_desc')}
                    isRTL={isRTL}
                  />
              ...
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_defects_by_supplier')}
                    desc={t('supplier_defects_by_supplier_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_passed_vs_failed')}
                    desc={t('supplier_passed_vs_failed_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_metrics_radar')}
                    desc={t('supplier_metrics_radar_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_defect_categories')}
                    desc={t('supplier_defect_categories_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
