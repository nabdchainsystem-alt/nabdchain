...
const _TOP_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = [
  {
    ...
    sparklineData: [2, 3, 3, 3, 4, 4],
    color: 'blue',
  },
  {
    id: '2',
    label: 'Dependency %',
    subtitle: 'Max Concentration',
    value: '38%',
    change: '+5%',
    trend: 'down',
    icon: <Users size={18} />,
  ...
  },
  {
    ...
    sparklineData: [45, 44, 43, 42, 42, 42],
    color: 'blue',
  },
];
...
const _SIDE_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = [
  ...
  },
  {
    ...
    subtitle: '% Critical Parts',
    value: '65%',
    change: '+5%',
    trend: 'up',
    icon: <TreeStructure size={18} />,
    sparklineData: [55, 60, 60, 62, 64, 65],
    color: 'blue',
  },
  {
    id: '7',
...
export const SupplierRiskDependencyDashboard: React.FC = () => {
  ...
  const TRANSLATED_TOP_KPIS = useMemo(
    () => [
      {
        id: '1',
        label: t('single_source'),
        subtitle: t('critical_components'),
        value: '4',
        change: '+1',
        trend: 'down' as const,
        icon: <LinkBreak size={18} />,
      ...
      {
        id: '2',
        label: t('dependency_pct'),
        subtitle: t('max_concentration'),
        value: '38%',
        change: '+5%',
        trend: 'down' as const,
        icon: <Users size={18} />,
  ...
  const TRANSLATED_SIDE_KPIS = useMemo(
    () => [
      {
        id: '5',
        label: t('disruption_events'),
        subtitle: t('last_12_months'),
        value: '3',
        change: '-1',
        trend: 'up' as const,
        icon: <Prohibit size={18} />,
      ...
      {
        id: '6',
        label: t('backup_coverage'),
        subtitle: t('pct_critical_parts'),
        value: '65%',
        change: '+5%',
        trend: 'up' as const,
        icon: <TreeStructure size={18} />,
      ...
      {
        id: '7',
        label: t('contract_expiry'),
        subtitle: t('next_90_days'),
        value: '5',
        change: '-3',
        trend: 'up' as const,
        icon: <Scales size={18} />,
      ...
      {
        id: '8',
        label: t('mitigation_plans'),
        subtitle: t('active_strategies'),
        value: '12',
        change: '+2',
        trend: 'up' as const,
        icon: <ShieldWarning size={18} />,
  ...
  const _TRANSLATED_SPEND_CONCENTRATION = useMemo(
    () => [
  ...
  const _TRANSLATED_RISK_SCORE_BY_SUPPLIER = useMemo(
    () => [
  ...
  const _mitigationPieOption: EChartsOption = useMemo(
    () => ({
      tooltip: { trigger: 'item', formatter: '{b}  {c}' },
      legend: {
        orient: 'horizontal',
      ...
      series: [
        {
          type: 'graph',
          layout: 'force',
          categories: [{ name: t('company') }, { name: t('tier_1') }, { name: t('tier_2') }],
