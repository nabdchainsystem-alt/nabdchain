            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_cost_total_spend')}
                    desc={t('supplier_cost_total_spend_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_cost_variance')}
                    desc={t('supplier_cost_variance_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_savings_achieved')}
                    desc={t('supplier_savings_achieved_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_spend_per_supplier')}
                    desc={t('supplier_spend_per_supplier_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_cost_waterfall')}
                    desc={t('supplier_cost_waterfall_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_spend_concentration')}
                    desc={t('supplier_spend_concentration_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_variance_trend')}
                    desc={t('supplier_variance_trend_desc')}
                    isRTL={isRTL}
                  />
