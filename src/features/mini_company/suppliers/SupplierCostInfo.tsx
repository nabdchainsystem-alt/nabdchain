...
export const SupplierCostInfo: React.FC<SupplierCostInfoProps> = ({ isOpen, onClose }) => {
    ...
    const questions = [
        { q: t('supplier_cost_q1'), a: t('supplier_cost_a1') },
        { q: t('supplier_cost_q2'), a: t('supplier_cost_a2') },
        { q: t('supplier_cost_q3'), a: t('supplier_cost_a3') },
        { q: t('supplier_cost_q4'), a: t('supplier_cost_a4') }
    ];
                ...
                <div className="flex-none flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-monday-dark-surface z-10">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                            ...
                            {t('supplier_cost_title')}
                        </h2>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{t('supplier_cost_subtitle')}</p>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('supplier_cost_total_spend')} desc={t('supplier_cost_total_spend_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_cost_variance')} desc={t('supplier_cost_variance_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_savings_achieved')} desc={t('supplier_savings_achieved_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_spend_per_supplier')} desc={t('supplier_spend_per_supplier_desc')} isRTL={isRTL} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title={t('supplier_cost_waterfall')} desc={t('supplier_cost_waterfall_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_spend_concentration')} desc={t('supplier_spend_concentration_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_variance_trend')} desc={t('supplier_variance_trend_desc')} isRTL={isRTL} />
                                    <DetailItem title={t('supplier_spend_table')} desc={t('supplier_spend_table_desc')} isRTL={isRTL} />
                                </div>
                            </div>
                        </div>
                    </section>
