...
export const SupplierStrategicValueGrowthInfo: React.FC<SupplierStrategicValueGrowthInfoProps> = ({ isOpen, onClose }) => {
    ...
    const questions = [
        { q: 'What defines a "Strategic Supplier"?', a: 'A partner with high alignment to long-term goals, delivering critical components or innovation.' },
        { q: 'How is "Innovation Score" measured?', a: 'Based on the number of joint R&D projects, patents co-developed, and new product introductions enabled.' },
        { q: 'What is the "Partnership Index"?', a: 'A composite metric (0-100) reflecting relationship strength, trust, and mutual investment levels.' },
        { q: 'How is "Spend Growth %" calculated?', a: 'Year-over-year increase in procurement volume, indicating deepening operational integration.' }
    ];
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 text-gray-600 dark:text-gray-300 pb-24">
                    <section>
                        ...
                        <p className="text-sm leading-relaxed p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-700">
                            This dashboard identifies high-value potential within the supply base. It focuses on strategic alignment, innovation contribution, and sustainable growth partnerships.
                        </p>
                    </section>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title="Strategic Suppliers" desc="Count of key partners." />
                                    <DetailItem title="Spend Growth %" desc="YoY procurement volume increase." />
                                    <DetailItem title="Innovation Score" desc="Rating of R&D contribution." />
                                    <DetailItem title="Revenue Impact" desc="Supplier-enabled sales growth." />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <DetailItem title="Growth Matrix" desc="Scatter plot of Growth Rate vs Strategic Value." />
                                    <DetailItem title="Contract Structure" desc="Breakdown of agreement types (Long-term vs Spot)." />
                                    <DetailItem title="Investment Growth" desc="Spend increase by strategic partner." />
                                    <DetailItem title="Partner Tiering" desc="Strategic vs Tactical segmentation." />
                                </div>
                            </div>
                        </div>
                    </section>
