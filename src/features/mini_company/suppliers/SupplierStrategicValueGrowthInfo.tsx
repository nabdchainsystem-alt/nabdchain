...
export const SupplierStrategicValueGrowthInfo: React.FC<SupplierStrategicValueGrowthInfoProps> = ({
  isOpen,
  onClose,
}) => {
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_strategic_suppliers')}
                    desc={t('supplier_strategic_suppliers_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem title={t('supplier_spend_growth')} desc={t('supplier_spend_growth_desc')} isRTL={isRTL} />
                  <DetailItem
                    title={t('supplier_innovation_score')}
                    desc={t('supplier_innovation_score_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_revenue_impact')}
                    desc={t('supplier_revenue_impact_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_growth_matrix')}
                    desc={t('supplier_growth_matrix_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_contract_structure')}
                    desc={t('supplier_contract_structure_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_investment_growth')}
                    desc={t('supplier_investment_growth_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_partner_tiering')}
                    desc={t('supplier_partner_tiering_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
