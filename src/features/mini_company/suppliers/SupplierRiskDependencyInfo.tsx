            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_single_source')}
                    desc={t('supplier_single_source_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_dependency_pct')}
                    desc={t('supplier_dependency_pct_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem title={t('supplier_risk_score')} desc={t('supplier_risk_score_desc')} isRTL={isRTL} />
                  <DetailItem
                    title={t('supplier_disruption_events')}
                    desc={t('supplier_disruption_events_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_dependency_map')}
                    desc={t('supplier_dependency_map_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_risk_distribution')}
                    desc={t('supplier_risk_distribution_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_risk_spend_concentration')}
                    desc={t('supplier_risk_spend_concentration_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_backup_coverage')}
                    desc={t('supplier_backup_coverage_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
