...
const _TOP_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = [
  {
    ...
    trend: 'down',
    icon: <Clock size={18} />,
    sparklineData: [16, 15, 15.5, 15, 14.5, 14.2],
    color: 'blue',
  },
  {
    id: '2',
  ...
  {
    id: '3',
    label: 'Response Time (RFQ)',
    subtitle: 'Avg Hours',
    value: '24h',
    change: '-2h',
    trend: 'down',
    icon: <Chats size={18} />,
    sparklineData: [28, 27, 26, 25, 24, 24],
    color: 'blue',
  },
  {
    id: '4',
...
const _SIDE_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = [
  ...
  },
  {
    ...
    sparklineData: [2.8, 2.6, 2.5, 2.4, 2.2, 2.1],
    color: 'blue',
  },
  {
    id: '7',
    label: 'Slowest Supplier',
    subtitle: 'Umbrella Corp',
    value: '35 Days',
    change: '+2',
    trend: 'down',
  ...
  },
  {
    id: '8',
    label: 'On-Time Quote',
    subtitle: 'RFQ Response Rate',
    value: '92%',
    change: '+4%',
    trend: 'up',
    icon: <Timer size={18} />,
    sparklineData: [85, 87, 88, 89, 90, 92],
    color: 'blue',
  },
];
...
export const SupplierLeadTimeResponsivenessDashboard: React.FC = () => {
  ...
  const TRANSLATED_TOP_KPIS = useMemo(
    () => [
      ...
      {
        id: '4',
        label: t('responsiveness_score'),
        subtitle: t('index_0_100'),
        value: '88',
        change: '+3',
        trend: 'up' as const,
        icon: <Medal size={18} />,
  ...
  const TRANSLATED_SIDE_KPIS = useMemo(
    () => [
      ...
      {
        id: '6',
        label: t('lead_time_variance'),
        subtitle: t('standard_dev'),
        value: '±2.1',
        change: '-0.3',
        trend: 'up' as const,
        icon: <TrendUp size={18} />,
      ...
      {
        id: '8',
        label: t('on_time_quote'),
        subtitle: t('rfq_response_rate'),
        value: '92%',
        change: '+4%',
        trend: 'up' as const,
        icon: <Timer size={18} />,
  ...
  const _TRANSLATED_LEAD_TIME_BY_SUPPLIER = useMemo(
    () => [
  ...
  const _TRANSLATED_RESPONSE_BY_SUPPLIER = useMemo(
    () => [
  ...
  const _performancePieOption: EChartsOption = useMemo(
    () => ({
      tooltip: { trigger: 'item', formatter: '{b}  {c}' },
      legend: {
        orient: 'horizontal',
