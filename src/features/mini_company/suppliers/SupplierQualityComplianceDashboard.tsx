...
const _TOP_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = [
  {
    ...
    trend: 'up',
    icon: <Bug size={18} />,
    sparklineData: [1.8, 1.6, 1.5, 1.4, 1.3, 1.2],
    color: 'blue',
  },
  {
    id: '2',
    label: 'Rejected Shipments',
    subtitle: 'Last 30 Days',
    value: '3',
    change: '-1',
    trend: 'up',
    icon: <Warning size={18} />,
    sparklineData: [5, 4, 6, 2, 4, 3],
    color: 'blue',
  },
  {
    id: '3',
    ...
    sparklineData: [91, 92, 92, 93, 94, 94.5],
    color: 'blue',
  },
  {
    id: '4',
    ...
    sparklineData: [98, 98, 98, 98, 98, 98],
    color: 'blue',
  },
];
...
const _SIDE_KPIS: (KPIConfig & { rawValue?: number; isCurrency?: boolean; color?: string })[] = [
  {
    ...
    sparklineData: [1000, 1050, 1100, 1150, 1200, 1245],
    color: 'blue',
  },
  {
    id: '6',
  ...
  },
  {
    id: '8',
    label: 'Audit Score',
    subtitle: 'Avg Compliance Audit',
    value: '96%',
    change: '+2%',
    trend: 'up',
    icon: <FileText size={18} />,
    sparklineData: [92, 93, 94, 94, 95, 96],
    color: 'blue',
  },
];
...
export const SupplierQualityComplianceDashboard: React.FC = () => {
  ...
  const TRANSLATED_TOP_KPIS = useMemo(
    () => [
      ...
      },
      {
        ...
        subtitle: t('regulatory_adherence'),
        value: '98%',
        change: t('stable'),
  ...
  const TRANSLATED_SIDE_KPIS = useMemo(
    () => [
      ...
      },
      {
        id: '8',
        label: t('audit_score'),
        subtitle: t('avg_compliance_audit'),
        value: '96%',
        change: '+2%',
        trend: 'up' as const,
        icon: <FileText size={18} />,
  ...
  const _TRANSLATED_DEFECTS_BY_SUPPLIER = useMemo(
    () => [
  ...
  const _TRANSLATED_QUALITY_BY_SUPPLIER = useMemo(
    () => [
  ...
  const _defectPieOption: EChartsOption = useMemo(
    () => ({
      tooltip: { trigger: 'item', formatter: '{b}  {c}' },
      legend: {
        orient: 'horizontal',
                      ...
                      <td className={`px-5 py-3 text-end`}>
                        <span
                          className={`inline-flex px-2 py-0.5 rounded text-[10px] font-bold ${
                            row.status === t('high_risk')
                              ? 'bg-red-100 text-red-700'
                              : row.status === t('watchlist')
