            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_ontime_delivery')}
                    desc={t('supplier_ontime_delivery_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_avg_lead_time')}
                    desc={t('supplier_avg_lead_time_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_delivery_accuracy')}
                    desc={t('supplier_delivery_accuracy_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_late_deliveries')}
                    desc={t('supplier_late_deliveries_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <DetailItem
                    title={t('supplier_ontime_vs_late')}
                    desc={t('supplier_ontime_vs_late_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_lead_time_trend')}
                    desc={t('supplier_lead_time_trend_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_monthly_heatmap')}
                    desc={t('supplier_monthly_heatmap_desc')}
                    isRTL={isRTL}
                  />
                  <DetailItem
                    title={t('supplier_reliability_index')}
                    desc={t('supplier_reliability_index_desc')}
                    isRTL={isRTL}
                  />
                </div>
              </div>
