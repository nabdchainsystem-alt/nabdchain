...
export const GTDClarifyView: React.FC<GTDClarifyViewProps> = ({ items, initialItemId, onProcess }) => {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto flex flex-col items-center">
            <h2 className={`text-2xl font-black ${isRTL ? '' : 'tracking-widest'} uppercase mb-6 text-[#1A1A1A] dark:text-white`}>{t('clarify')}</h2>
            ...
            {!currentItem ? (
                <div className="flex flex-col items-center justify-center p-8 text-center opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
                    ...
                    <h3 className={`text-2xl ${isRTL ? 'font-sans font-bold' : 'font-serif italic'} text-gray-800 dark:text-white mb-2`}>{t('all_clear')}</h3>
                    <p className="text-sm text-gray-400">{t('inbox_empty_capture_more')}</p>
                </div>
            ) : (
                <>
                    {/* Item Card */}
                    <div className="relative w-full mb-6 group">
                        ...
                        >
                            <div className={`absolute top-4 left-1/2 -translate-x-1/2 text-[10px] font-bold ${isRTL ? '' : 'tracking-widest'} uppercase text-gray-300`}>
                                {t('item_x_of_y').replace('{0}', String(currentIndex + 1)).replace('{1}', String(items.length))}
                            </div>

                            <h3 className={`text-lg ${isRTL ? 'font-sans font-medium' : 'font-serif italic'} text-[#1A1A1A] dark:text-gray-100 mb-4 px-4 leading-tight`}>
                                "{currentItem.title || 'Untitled'}"
                            </h3>

                            <div className={`flex items-center justify-center gap-2 text-[10px] font-bold ${isRTL ? '' : 'tracking-widest'} uppercase text-gray-400 dark:text-gray-500`}>
                    ...
                    <AnimatePresence mode="wait">
                        {step === 'decision' && (
                            ...
                            >
                                <h4 className={`text-center ${isRTL ? 'font-sans font-medium' : 'font-serif italic'} text-base text-gray-500 mb-6`}>{t('is_this_actionable')}</h4>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-bold text-gray-700 dark:text-gray-300 group-hover:text-red-500 mb-0.5">{t('no')}</span>
                                        <span className="text-[10px] text-center text-gray-400 group-hover:text-red-400">{t('trash_reference_someday')}</span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-bold mb-0.5">{t('yes')}</span>
                                        <span className="text-[10px] text-center opacity-60">{t('do_delegate_defer_project')}</span>
                                    </button>
                                </div>
                            </motion.div>
                        )}
                        ...
                        {step === 'non-actionable' && (
                            ...
                            >
                                <div className="flex items-center justify-between mb-6 px-2">
                                    ...
                                    <h4 className={`text-center ${isRTL ? 'font-sans font-medium' : 'font-serif italic'} text-base text-gray-500`}>{t('organize_non_actionables')}</h4>
                                ...
                                <div className="grid grid-cols-3 gap-3 mb-2">
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-xs text-gray-800 dark:text-white mb-0.5">{t('trash')}</span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-xs text-gray-800 dark:text-white mb-0.5">{t('reference')}</span>
                                        <span className="text-[10px] text-gray-400 scale-90">{t('file_away_for_info')}</span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-xs text-gray-800 dark:text-white mb-0.5">{t('someday_maybe')}</span>
                                    </button>
                                </div>
                            </motion.div>
                        )}
                        ...
                        {step === 'actionable' && (
                            ...
                            >
                                <div className="flex items-center justify-between mb-6 px-2">
                                    ...
                                    <h4 className={`text-center ${isRTL ? 'font-sans font-medium' : 'font-serif italic'} text-base text-gray-500`}>{t('what_is_next_step')}</h4>
                                    <div className="w-4" /> {/* Spacer */}
                                </div>
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-start">
                                            <h5 className="font-bold text-xs text-blue-900 dark:text-blue-100">{t('its_a_project')}</h5>
                                            <p className="text-[10px] text-blue-400 dark:text-blue-300">{t('requires_multiple_steps')}</p>
                                        </div>
                                    </div>
                                    <ArrowRight size={14} className="text-blue-300 group-hover:ltr:translate-x-1 group-hover:rtl:-translate-x-1 transition-transform" />
                                </button>
                                ...
                                <div className="grid grid-cols-2 gap-3 mb-2">
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-xs text-gray-800 dark:text-white mb-0.5">{t('do_it_2m')}</span>
                                        <span className="text-[10px] text-gray-400">{t('mark_as_done')}</span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-xs text-gray-800 dark:text-white mb-0.5">{t('delegate')}</span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-xs text-gray-800 dark:text-white mb-0.5">{t('next_actions')}</span>
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-xs text-gray-800 dark:text-white mb-0.5">{t('defer_calendar')}</span>
                                    </button>
                                </div>
                            </motion.div>
                        )}
                            ...
                            >
                                ...
                                <div className="w-full md:w-48 bg-gray-50/50 dark:bg-black/20 border-r border-gray-100 dark:border-white/5 flex flex-col">
                                    <div className="p-3 flex-1 overflow-y-auto space-y-1">
                                        {[
                                            { label: t('today'), date: new Date(), sub: new Date().toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { weekday: 'short' }) },
                                            { label: t('tomorrow'), date: new Date(Date.now() + 86400000), sub: new Date(Date.now() + 86400000).toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { weekday: 'short' }) },
                                            { label: t('next_week'), date: new Date(Date.now() + 7 * 86400000), sub: new Date(Date.now() + 7 * 86400000).toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { month: 'short', day: 'numeric' }) },
                                            { label: t('next_weekend'), date: (() => { const d = new Date(); d.setDate(d.getDate() + (6 - d.getDay() + 7) % 7); return d; })(), sub: (() => { const d = new Date(); d.setDate(d.getDate() + (6 - d.getDay() + 7) % 7); return d.toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { month: 'short', day: 'numeric' }); })() },
                                            { label: t('two_weeks'), date: new Date(Date.now() + 14 * 86400000), sub: new Date(Date.now() + 14 * 86400000).toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { month: 'short', day: 'numeric' }) },
                                            { label: t('four_weeks'), date: new Date(Date.now() + 28 * 86400000), sub: new Date(Date.now() + 28 * 86400000).toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { month: 'short', day: 'numeric' }) },
                                        ].map((option, idx) => (
                                            <button
                                                key={idx}
                                                onClick={() => {
                                    ...
                                    <div className="p-3 border-t border-gray-100 dark:border-white/5">
                                        <button className="w-full text-start px-3 py-1.5 rounded-lg hover:bg-gray-200 dark:hover:bg-white/10 flex items-center justify-between text-xs font-medium text-gray-700 dark:text-gray-200 transition-colors">
                                            <span>{t('set_recurring')}</span>
                                ...
                                <div className="flex-1 p-5 flex flex-col">
                                    ...
                                    <div className="flex gap-3 mb-6 pr-8">
                                        <div className="flex-1 bg-gray-50 dark:bg-white/5 rounded-lg flex items-center px-2.5 py-1.5 gap-2 opacity-50 cursor-not-allowed">
                                            ...
                                            <span className="text-xs text-gray-400 font-medium">{t('start_date')}</span>
                                        </div>
                                        <div className="flex-1 bg-white dark:bg-black/20 border border-blue-100 dark:border-blue-500/30 rounded-lg flex items-center px-2.5 py-1.5 gap-2 shadow-sm">
                                            ...
                                            <span className="text-xs font-bold text-gray-800 dark:text-white font-datetime">
                                                {selectedDate ? selectedDate.toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { month: 'short', day: 'numeric', year: 'numeric' }) : t('due_date')}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-baseline gap-2">
                                            <span className={`text-lg font-bold text-gray-900 dark:text-white ${isRTL ? 'font-sans' : 'font-serif'}`}>
                                                {currentMonth.toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { month: 'long', year: 'numeric' })}
                                            </span>
                                            <button
                                                onClick={() => setCurrentMonth(new Date())}
                                                className={`text-[10px] font-bold uppercase ${isRTL ? '' : 'tracking-wider'} text-gray-400 hover:text-blue-500 transition-colors`}
                                            >
                                                {t('today')}
                                            </button>
                                        </div>
                                    ...
                                    <div className="flex-1">
                                        <div className="grid grid-cols-7 mb-2 text-center">
                                            {(language === 'ar'
                                                ...
                                                <div key={day} className={`text-[10px] font-bold text-gray-400 uppercase ${isRTL ? '' : 'tracking-wider'}`}>{day}</div>
                                            ))}
                                        </div>
                                    ...
                                    <div className="mt-6 flex justify-end gap-2">
                                        <button
                                            onClick={() => setStep('actionable')}
                                            className={`px-4 py-1.5 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg text-xs font-bold text-gray-500 transition-colors uppercase ${isRTL ? '' : 'tracking-wider'}`}
                                        >
                                            {t('cancel')}
                                        </button>
                                        <button
                                            ...
                                            className={`px-4 py-1.5 bg-[#1A1A1A] dark:bg-white text-white dark:text-black rounded-lg text-xs font-bold shadow-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all uppercase ${isRTL ? '' : 'tracking-wider'}`}
                                        >
                                            {t('done')}
                                        </button>
                                    </div>
