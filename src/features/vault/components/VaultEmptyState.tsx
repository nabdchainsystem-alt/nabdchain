  ...
  if (type === 'active-search') {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center animate-fade-in-up">
        ...
        <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('no_matching_items')}</h3>
  ...
  if (type === 'empty-category') {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center animate-fade-in-up">
        ...
        <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">{t(config.title) || config.title}</h3>
        <p className="text-gray-500 dark:text-gray-400 max-w-sm mb-8">{t(config.desc) || config.desc}</p>
  ...
  if (type === 'empty-folder') {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center animate-fade-in-up">
        ...
        <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">{t('this_folder_is_empty')}</h3>
        <p className="text-gray-500 dark:text-gray-400 max-w-sm mb-8">{t('add_new_items_folder')}</p>
        {onCreateItem && (
    ...
    <div className="flex flex-col items-center justify-center h-full p-8 animate-fade-in-up">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">{t('secure_digital_life')}</h2>
          <p className="text-lg text-gray-500 dark:text-gray-400 max-w-xl mx-auto">{t('vault_empty_desc')}</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 border-t border-gray-200 dark:border-monday-dark-border pt-8">
          ...
          <div className="text-sm text-gray-400 dark:text-gray-500 flex items-center gap-2">
            <span className="px-2 py-0.5 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded text-xs font-mono">
              N
            </span>
