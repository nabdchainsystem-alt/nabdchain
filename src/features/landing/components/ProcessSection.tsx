            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row gap-16">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <h3 className="text-3xl font-bold mb-4 tracking-tight">Advanced Neural <br /> Network Integration</h3>
                        <p className="text-zinc-400 mb-10 max-w-sm mx-auto md:mx-0">
                            Leverage the power of our proprietary L-4 Neural Engine for predictive analytics and automated decision making.
                        </p>
                        <a href="#" className="text-sm font-medium hover:text-white text-zinc-500 flex items-center justify-center md:justify-start gap-1 mb-10">
