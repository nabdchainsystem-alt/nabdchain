                ...
                <div className="flex flex-col md:flex-row gap-20 items-center">
                    <div className="flex-1">
                        ...
                        <p className="text-zinc-600 dark:text-monday-dark-text-secondary text-lg mb-8 leading-relaxed">
                            A complete suite of tools to manage your data, procurement, and collaboration. Integrate your entire workflow into one seamless dashboard.
                        </p>
                        <div className="space-y-4">
                            {['Live Collaboration', 'Procurement', 'Warehouse'].map((feature, i) => (
                                <div key={feature} className="border-l-2 border-zinc-200 dark:border-monday-dark-border pl-4 py-2 cursor-pointer hover:border-[#2563EB] transition-colors">
                                    <h4 className={`text-sm font-bold ${i === 0 ? 'text-[#2563EB]' : 'text-zinc-400 dark:text-monday-dark-text-secondary'}`}>{feature}</h4>
                                    {i === 0 && <p className="text-sm text-zinc-500 dark:text-monday-dark-text-secondary mt-1">Real-time multiplayer editing, task assignment, and live notifications...</p>}
                                </div>
                            ))}
                        </div>
                    </div>
