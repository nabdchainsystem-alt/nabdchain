        ...
        <div className="relative flex flex-col justify-between p-5 bg-white dark:bg-[#1C1C1E] border border-gray-100 dark:border-gray-800 rounded-xl shadow-sm hover:shadow-md transition-all h-[140px] overflow-hidden group">
            <div className="z-10 relative">
                <div className="flex justify-between items-start mb-2">
                    ...
                    <div className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold ${isPositive ? 'bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-50 text-red-700'
                        }`}>
    ...
    return (
        <div className="space-y-12 pb-10">
            ...
            <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-6">Compact, responsive cards with improved area charts. Fits 4 per row.</p>
            ...
            <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-6">High-contrast, bold typography designs focusing on essential data.</p>
            ...
            <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-6">Communicating trends and actions through visual metaphors.</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="group h-[160px] bg-white dark:bg-[#1C1C1E] border border-gray-200 dark:border-gray-800 rounded-xl p-6 relative cursor-pointer hover:border-black dark:hover:border-white transition-colors duration-200">
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <ArrowRight size={20} className="text-gray-300 group-hover:text-black dark:group-hover:text-white transition-colors" />
                        </div>
                        <div>
                            <span className="text-sm text-gray-500 font-medium block mb-1">Total Balance</span>
                            <span className="text-2xl font-bold text-gray-900 dark:text-white group-hover:underline decoration-2 underline-offset-4">$8,290.00</span>
                        </div>
                    </div>
