                ...
                <header className="flex flex-col gap-8 mb-10">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                        <div className="flex flex-col gap-1">
                            <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 dark:text-monday-dark-text">{t('automation_rules')}</h1>
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 items-center justify-between bg-white dark:bg-monday-dark-surface border border-gray-200 dark:border-monday-dark-border p-1.5 rounded-xl shadow-[0_1px_2px_0_rgba(0,0,0,0.05)]">
                        ...
                        <div className="flex items-center gap-1 overflow-x-auto w-full lg:w-auto pb-2 lg:pb-0 px-2 lg:px-0 no-scrollbar">
                            ...
                            <button className="whitespace-nowrap px-4 py-2 rounded-lg text-gray-500 dark:text-monday-dark-text-secondary hover:text-gray-900 dark:hover:text-monday-dark-text hover:bg-gray-50 dark:hover:bg-monday-dark-hover text-sm font-medium transition-colors flex items-center gap-2">
                                {t('active')} <span className="text-[10px] bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 px-1.5 py-0.5 rounded-full font-bold border border-indigo-100 dark:border-indigo-800">8</span>
                            </button>
                ...
                <div className={`grid gap-6 pb-12 ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 xl:grid-cols-3' : 'grid-cols-1'}`}>
                    ...
                    <div className="group relative flex flex-col bg-white dark:bg-monday-dark-surface border border-gray-100 dark:border-monday-dark-border rounded-xl p-6 transition-all duration-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-1px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.08),0_4px_6px_-2px_rgba(0,0,0,0.04)] hover:border-indigo-100 dark:hover:border-indigo-800 hover:-translate-y-1">
                        <div className="flex justify-between items-start mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-gray-900 dark:text-monday-dark-text font-bold text-lg leading-tight group-hover:text-indigo-600 transition-colors">Project Kickoff</h3>
                                    <p className="text-xs text-gray-400 dark:text-monday-dark-text-muted font-medium mt-1">ID: #RULE-8821</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-gray-50/80 dark:bg-monday-dark-elevated/50 rounded-xl p-4 mb-5 border border-gray-100 dark:border-monday-dark-border">
                            <div className="flex items-center gap-3 relative z-10">
                                <div className="flex-1 min-w-0 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-monday-dark-text truncate w-full">{t('task_completed')}</p>
                                    <p className="text-[10px] text-gray-500 dark:text-monday-dark-text-muted truncate w-full">Status = 'Done'</p>
                                </div>
                                ...
                                <div className="flex-1 min-w-0 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-monday-dark-text truncate w-full">{t('notify_slack')}</p>
                                    <p className="text-[10px] text-gray-500 dark:text-monday-dark-text-muted truncate w-full">Channel #general</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="group relative flex flex-col bg-white dark:bg-monday-dark-surface border border-gray-100 dark:border-monday-dark-border rounded-xl p-6 transition-all duration-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-1px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.08),0_4px_6px_-2px_rgba(0,0,0,0.04)] opacity-80 hover:opacity-100">
                        <div className="flex justify-between items-start mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-gray-700 dark:text-monday-dark-text-secondary font-bold text-lg leading-tight">Email Digest</h3>
                                    <p className="text-xs text-gray-400 dark:text-monday-dark-text-muted font-medium mt-1">ID: #RULE-1042</p>
                                </div>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <div className="bg-gray-50/50 dark:bg-monday-dark-elevated/30 rounded-xl p-4 mb-5 border border-gray-100 dark:border-monday-dark-border grayscale opacity-70 group-hover:grayscale-0 group-hover:opacity-100 transition-all">
                            <div className="flex items-center gap-3 relative z-10">
                                <div className="flex-1 min-w-0 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-monday-dark-text truncate w-full">{t('time_schedule')}</p>
                                    <p className="text-[10px] text-gray-500 dark:text-monday-dark-text-muted truncate w-full">{t('every_friday')}</p>
                                </div>
                                <div className="text-gray-300 dark:text-monday-dark-text-muted flex items-center justify-center pb-4">
                                    <ArrowRight size={24} />
                                </div>
                                <div className="flex-1 min-w-0 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-monday-dark-text truncate w-full">{t('send_report')}</p>
                                    <p className="text-[10px] text-gray-500 dark:text-monday-dark-text-muted truncate w-full">{t('email_to_admin')}</p>
                                </div>
                            </div>
                        </div>
                        <div className="mt-auto flex items-center justify-between border-t border-gray-100 dark:border-monday-dark-border pt-4">
                    ...
                    <div className="group relative flex flex-col bg-white dark:bg-monday-dark-surface border border-gray-100 dark:border-monday-dark-border rounded-xl p-6 transition-all duration-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-1px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.08),0_4px_6px_-2px_rgba(0,0,0,0.04)] hover:border-indigo-100 dark:hover:border-indigo-800 hover:-translate-y-1">
                        <div className="flex justify-between items-start mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-gray-900 dark:text-monday-dark-text font-bold text-lg leading-tight group-hover:text-red-600 transition-colors">{t('urgent_ticket_alert')}</h3>
                                    <p className="text-xs text-gray-400 dark:text-monday-dark-text-muted font-medium mt-1">ID: #RULE-991A</p>
                                </div>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input defaultChecked className="sr-only peer" type="checkbox" />
                        ...
                        <div className="bg-gray-50/80 dark:bg-monday-dark-elevated/50 rounded-xl p-4 mb-5 border border-gray-100 dark:border-monday-dark-border">
                            <div className="flex items-center gap-3 relative z-10">
                                <div className="flex-1 min-w-0 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-monday-dark-text truncate w-full">{t('ticket_tagged')}</p>
                                    <p className="text-[10px] text-gray-500 dark:text-monday-dark-text-muted truncate w-full">Tag = 'Urgent'</p>
                                </div>
                                <div className="text-gray-300 dark:text-monday-dark-text-muted flex items-center justify-center pb-4">
                                    <ArrowRight size={24} />
                                </div>
                                <div className="flex-1 min-w-0 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-monday-dark-text truncate w-full">{t('page_oncall')}</p>
                    ...
                    <div className="group relative flex flex-col bg-white border-2 border-dashed border-gray-200 dark:border-monday-dark-border hover:border-gray-300 dark:hover:border-monday-dark-border-strong rounded-xl p-6 transition-all duration-300">
                        ...
                        <div className="flex justify-between items-start mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-gray-800 dark:text-monday-dark-text font-bold text-lg leading-tight">New Lead Processing</h3>
                                    <p className="text-xs text-gray-400 dark:text-monday-dark-text-muted font-medium mt-1">ID: #RULE-DRAFT</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-auto flex items-center justify-between border-t border-gray-100 dark:border-monday-dark-border pt-4">
                            <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-monday-dark-text-secondary">
                                <span>{t('last_edited')} 3 {t('days_ago')}</span>
                            </div>
                    ...
                    <div className="group relative flex flex-col bg-white dark:bg-monday-dark-surface border border-gray-100 dark:border-monday-dark-border rounded-xl p-6 transition-all duration-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-1px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.08),0_4px_6px_-2px_rgba(0,0,0,0.04)] hover:border-indigo-100 dark:hover:border-indigo-800 hover:-translate-y-1">
                        <div className="flex justify-between items-start mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-gray-900 dark:text-monday-dark-text font-bold text-lg leading-tight group-hover:text-teal-600 transition-colors">Sync to Airtable</h3>
                                    <p className="text-xs text-gray-400 dark:text-monday-dark-text-muted font-medium mt-1">ID: #RULE-332B</p>
                                </div>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input defaultChecked className="sr-only peer" type="checkbox" />
                        ...
                        <div className="bg-gray-50/80 dark:bg-monday-dark-elevated/50 rounded-xl p-4 mb-5 border border-gray-100 dark:border-monday-dark-border">
                            <div className="flex items-center gap-3 relative z-10">
                                <div className="flex-1 min-w-0 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-monday-dark-text truncate w-full">{t('new_user')}</p>
                                    <p className="text-[10px] text-gray-500 dark:text-monday-dark-text-muted truncate w-full">{t('on_signup')}</p>
                                </div>
                                <div className="text-gray-300 dark:text-monday-dark-text-muted flex items-center justify-center pb-4">
                                    <ArrowRight size={24} />
                                </div>
                                <div className="flex-1 min-w-0 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-monday-dark-text truncate w-full">{t('create_record')}</p>
                                    <p className="text-[10px] text-gray-500 dark:text-monday-dark-text-muted truncate w-full">Airtable: Users</p>
                                </div>
                            </div>
                        </div>
                        <div className="mt-auto flex items-center justify-between border-t border-gray-100 dark:border-monday-dark-border pt-4">
                    ...
                    <button className="group flex flex-col items-center justify-center bg-gray-50/50 border-2 border-dashed border-gray-200 hover:border-indigo-400 hover:bg-white dark:hover:bg-monday-dark-surface rounded-xl p-6 transition-all duration-300 min-h-[280px]">
                        <div className="w-16 h-16 rounded-full bg-white dark:bg-monday-dark-surface shadow-sm border border-gray-100 dark:border-monday-dark-border group-hover:shadow-md group-hover:scale-110 flex items-center justify-center mb-4 transition-all duration-300">
                            <Plus className="text-gray-400 dark:text-monday-dark-text-muted group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors" size={32} />
                        </div>
                        <h3 className="text-gray-500 dark:text-monday-dark-text-secondary group-hover:text-indigo-600 dark:group-hover:text-indigo-400 font-bold text-lg transition-colors">{t('create_new_rule')}</h3>
