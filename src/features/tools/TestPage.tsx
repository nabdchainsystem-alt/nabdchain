...
export const TestPage: React.FC = () => {
    // Initial state with one blank tab
    ...
    return (
        <div className="flex-1 flex flex-col h-full overflow-hidden bg-transparent">
                    ...
                    <div className="pl-[24px] pr-[20px] pt-4 pb-0">
                        ...
                        <div className="flex items-center gap-0 w-full border-b border-gray-200 dark:border-gray-800">
                            ...
                            <button
                                ...
                                className="ml-2 p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-400 transition-colors"
                                title="Add Tab"
                            >
                                <Plus size={16} />
                            </button>
            ...
            {/* Content Area */}
            <div className="flex-1 overflow-y-auto bg-[#F5F6F8] dark:bg-monday-dark-bg p-6">
                {activeTab?.content}
            </div>
        </div>
    );
