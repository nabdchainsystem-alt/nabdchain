...
const WhiteboardView: React.FC<{ boardId: string }> = ({ _boardId }) => {
    ...
    <div className="relative w-full h-full bg-white dark:bg-monday-dark-bg font-sans overflow-hidden select-none">
      ...
      >
        ...
        {textItems.map((item) => (
          <div
            key={item.id}
            className={`absolute p-2 shadow-sm rounded border ${
              item.type === 'note'
          ...
          <div className="glass-panel flex items-center gap-4 px-2 py-2 rounded-xl shadow-sm">
            <div className="flex items-center px-2">
              ...
              <div className="flex -space-x-2 overflow-hidden">
                <div
                  className="z-30 inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-monday-dark-bg bg-center bg-cover border border-white"
                  style={{
                    backgroundImage:
                      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAK2xh5jgqi0xaEVydCWWbsfYdUrjoVWw_Trypbzbs8-hiz_WAQ2FKiw4m_9lzr7gUuGcWdP_Jq5YHbbBDg0_kf6E5u4BrW7CHIsdn3_1FTG0_0UY0HhdHQp2gLggOE2bg3iKfRbmU9wa374WU5DqhZw8KVU2M7U1-WhSZzUANXJDvUvLvcI5c3KxCf_dy3cm8bKmZiZ3HhCtYAO5GPRqmDcrd-Gxkz4irDj8dsrb1MUHMUM4mMQSRDcHIDs9AHGFnFUvRTZCGruSKR")',
                  }}
                ></div>
                <div
                  className="z-20 inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-monday-dark-bg bg-center bg-cover border border-white"
                  style={{
                    backgroundImage:
                      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCRCbbKse96EXyElTNnTs07-a8WvljrY_6eIrP-rf6ACh2LWfSYiApx916H7khlnWmletK2eq2Jp9Bn52sb4D4vjf_sQBApz6Gsc0uw4KMWYLdAYMVQ0eEIcyjjZBa0hQdOQhw3NFGeZqBm1rlahMfsiIHZtETNJ6OhO4jLcmCHO5R4yOnA9SiEp9pivSxBzUheDH-OcWLp3VKpMheLc4rCXYOHUu-ckEI0sPz1OIFFq0GOu7J8hUxlR7K7w56cr3YaUsZh0DcAQ9Qm")',
                  }}
                ></div>
          ...
          <div className="flex-1 flex justify-center">
            <div className="glass-panel flex items-center p-2 rounded-2xl shadow-2xl gap-1">
              <div className="flex items-center gap-0.5">
                ...
                <button
                  className="p-2.5 rounded-xl hover:bg-gray-100 dark:hover:bg-monday-dark-hover text-gray-600 dark:text-monday-dark-text-secondary transition-colors"
                  title="Lasso Select"
              ...
              <div className="flex items-center gap-0.5">
                ...
                >
                  <Pen size={20} />
                  {currentTool === 'pen' && (
                    <div className="absolute bottom-1 right-1 w-1.5 h-1.5 rounded-full bg-[#00bdc7] animate-pulse"></div>
                  )}
                </button>
                <button
      ...
      <div className="fixed top-24 left-1/2 -translate-x-1/2 w-full max-w-md px-4 z-50 transition-all opacity-0 pointer-events-none data-[visible=true]:opacity-100 data-[visible=true]:pointer-events-auto">
        <div className="glass-panel rounded-2xl shadow-2xl p-2 flex items-center">
          ...
          <input
            className="w-full bg-transparent border-none focus:ring-0 text-sm font-medium py-3 placeholder:text-gray-400"
            placeholder={t('search_commands')}
          />
          <div className="flex items-center gap-1 px-3">
            <kbd className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-monday-dark-hover border border-gray-300 dark:border-monday-dark-border text-[10px] text-gray-500 font-bold">
              ESC
            </kbd>
          </div>
        </div>
