...
import { Clock, ChartPie, Target, TrendUp, Info } from 'phosphor-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h3 className="font-semibold text-stone-800 dark:text-stone-200">Capacity Overview</h3>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="p-6 bg-white dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-700">
          ...
          <p className="text-3xl font-bold text-stone-800 dark:text-stone-200">{totalCapacity}h</p>
          <p className="text-sm text-stone-500 mt-1">per {viewMode}</p>
        </div>
        ...
        <div className="p-6 bg-white dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-700">
          ...
          <p className="text-3xl font-bold text-green-600">{allocatedHours}h</p>
          <p className="text-sm text-stone-500 mt-1">{Math.round((allocatedHours / totalCapacity) * 100)}% utilized</p>
        </div>
        ...
        <div className="p-6 bg-white dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-700">
          ...
          <p className="text-3xl font-bold text-amber-600">{availableHours}h</p>
          <p className="text-sm text-stone-500 mt-1">ready to allocate</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        {/* By Project */}
        <div className="p-6 bg-white dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-700">
          <h4 className="font-semibold text-stone-800 dark:text-stone-200 mb-4">Allocation by Project</h4>
          <div className="space-y-3">
            {projectAllocations.map((project) => (
              <div key={project.name}>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-sm text-stone-600 dark:text-stone-400">{project.name}</span>
                  <span className="text-sm font-medium text-stone-800 dark:text-stone-200">{project.hours}h</span>
                </div>
        ...
        <div className="p-6 bg-white dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-700">
          <h4 className="font-semibold text-stone-800 dark:text-stone-200 mb-4">Capacity Utilization</h4>
          <div className="h-48 flex items-center justify-center bg-stone-50 dark:bg-stone-800 rounded-lg">
            <div className="text-center">
              ...
              <p className="text-sm text-stone-500">Capacity chart visualization</p>
      ...
      <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-200 dark:border-indigo-800">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-medium text-indigo-700 dark:text-indigo-300 mb-1">Capacity Recommendations</h4>
      ...
      <div className="p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg text-center">
        <p className="text-sm text-amber-700 dark:text-amber-300">Capacity Planner - Full functionality coming soon</p>
      </div>
    </div>
  );
};
