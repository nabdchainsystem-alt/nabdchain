...
import { ChartBar as BarChart3, Sparkle as Sparkles, Trash } from 'phosphor-react';
  ...
  return (
    <>
      <RoomTable
        ...
        showPagination={true}
        renderCustomActions={({ setRows, _setColumns, setIsChartModalOpen, setIsAIReportModalOpen }) => (
