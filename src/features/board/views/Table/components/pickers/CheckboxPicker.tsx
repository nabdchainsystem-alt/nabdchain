...
export const CheckboxPicker: React.FC<CheckboxPickerProps> = memo(
  ({ value, onSelect, onClose, triggerRect, label = 'Checkbox' }) => {
            ...
            >
              <div
                className={`w-5 h-5 rounded flex items-center justify-center ${
                  value === true ? 'bg-green-500 text-white' : 'border-2 border-stone-300 dark:border-stone-600'
                }`}
              >
            ...
            >
              <div
                className={`w-5 h-5 rounded flex items-center justify-center border-2 ${
                  value === false ? 'border-stone-400 dark:border-stone-500' : 'border-stone-300 dark:border-stone-600'
                }`}
              ></div>
  ...
  return (
    <button
      ...
      className={`w-5 h-5 rounded flex items-center justify-center transition-colors ${
        checked ? 'bg-green-500 text-white' : 'border-2 border-stone-300 dark:border-stone-600 hover:border-green-400'
