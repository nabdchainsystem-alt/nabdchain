      ...
      <div className="flex-1 overflow-y-auto">
        {docs.map((doc) => (
          <div
            ...
            className={`p-4 border-b border-stone-100 dark:border-stone-800/50 cursor-pointer transition-colors group ${
          ...
          >
            <h3
              className={`font-serif font-medium text-base mb-1 ${
                selectedDocId === doc.id ? 'text-stone-900 dark:text-stone-50' : 'text-stone-800 dark:text-stone-200'
              }`}
            >
              {doc.title || 'Untitled'}
            </h3>
