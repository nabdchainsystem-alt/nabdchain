      ...
      try {
        ...
        if (user) {
          ...
          if (!isUserInList) {
            ...
            const emailObj = u.primaryEmailAddress as { emailAddress?: string } | undefined;
            const name = (u.fullName || u.firstName || u.name || emailObj?.emailAddress || 'Me') as string;
            const avatar = (u.imageUrl || u.avatarUrl) as string | undefined;
