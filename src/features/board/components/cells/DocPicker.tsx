      ...
      >
        ...
        <div className="flex-1 overflow-y-auto max-h-[200px] p-1 custom-scrollbar">
          {loading ? (
            ...
            <div className="py-4 text-center text-xs text-stone-400">No board context available</div>
            ...
            <div className="flex flex-col gap-0.5">
              {filteredDocs.map((doc) => (
                ...
                >
                  ...
                  {current?.id === doc.id && <span className="text-[10px] text-blue-500 font-medium">Selected</span>}
                </button>
              ))}
            </div>
          )}
