...
import { X, Plus as PlusIcon, Trash as Trash2, Check } from 'phosphor-react';
      ...
      >
        <div className="bg-white dark:bg-stone-900 rounded-lg shadow-2xl w-[500px] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="p-6 space-y-6">
            {/* Column Name */}
            <div>
              <label className="block text-sm font-semibold text-stone-700 dark:text-stone-300 mb-2">Name</label>
              <input
                type="text"
                value={columnLabel}
            ...
            {/* Options */}
            <div>
              <label className="block text-sm font-semibold text-stone-700 dark:text-stone-300 mb-2">Options</label>
            ...
            <div className="grid grid-cols-5 gap-2 mb-3">
              {PRESET_COLORS.map((color) => (
                <button
                  key={color}
                  onClick={() => {
                    updateOption(activeColorPicker.id, { color });
