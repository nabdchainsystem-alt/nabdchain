            ...
            <div className="flex-1 overflow-y-auto">
              <div className="px-6 py-5">
                        ...
                        <>
                          ...
                          <div className="absolute top-full left-0 mt-1 z-50 bg-white dark:bg-stone-800 rounded-lg shadow-lg border border-stone-200 dark:border-stone-700 py-1 min-w-[140px]">
                            {allStatuses.map((s) => (
                              ...
                              >
                                <div
                                  className={`w-2 h-2 rounded-full ${getStatusColor(s.id).bg.replace('dark:bg-', 'bg-').split(' ')[0]}`}
                                />
                                {s.title}
                ...
                >
                  <CaretDown
                    size={14}
                    className={`transform transition-transform ${showCollapsedFields ? 'rotate-180' : ''}`}
                  />
