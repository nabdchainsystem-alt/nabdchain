...
export const TemplateCenter: React.FC<TemplateCenterProps> = ({ isOpen, onClose, _onSelectTemplate }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-stone-900 rounded-xl shadow-2xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-hidden">
        <div className="p-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-stone-800 dark:text-stone-200 mb-2">Template Center</h2>
          <p className="text-stone-500 mb-6">Choose from 50+ templates to get started quickly</p>
          <p className="text-amber-600 dark:text-amber-400 text-sm">Coming Soon</p>
          <button
            onClick={onClose}
