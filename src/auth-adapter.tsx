...
export const MockSignIn: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-4 p-8 border rounded-lg shadow-md bg-white w-full max-w-md">
            ...
            <div className="text-base text-gray-500 mb-4 max-w-[260px] text-center">
                Choose your login method
            </div>

            {/* Standard User Login (Clerk) */}
            <div className="w-full space-y-2">
                <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider text-center mb-1">Standard Access</div>
                <button
            ...
            <div className="w-full space-y-2">
                <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider text-center mb-1">Developer Access</div>
